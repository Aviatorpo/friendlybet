...
const STORY_COPY_OVERRIDES = {
  'BRA-NOR': {
    title: {
      he: 'נורווגיה ניצחה את ברזיל 2-1: לרבע הגמר',
      en: 'Norway beat Brazil 2-1: into the quarterfinals',
    },
    caption: {
      he: 'נורווגיה הדיחה את ברזיל עם 2-1 בשמינית הגמר. האלנד הפך ערב ענק לכרטיס לרבע הגמר 🔥',
    ...
    pool_focuses: [
      {
        ...
        team_code: 'NOR',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. 2-1 על ברזיל הופך את הבחירה הזאת לרגע ענק בבראקט 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-1 על ברזיל הופך את הבחירות האלה לרגע ענק בבראקט 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-1 על ברזיל הופך את הבחירות האלה לרגע ענק בבראקט 🔥',
        en_name: '{names} picked {team} to advance in the knockout bracket. A 2-1 over Brazil turns that pick into a huge bracket moment 🔥',
        en_names: '{names} picked {team} to advance in the knockout bracket. A 2-1 over Brazil turns those picks into a huge bracket moment 🔥',
        en_count: '{names} picked {team} to advance in the knockout bracket. A 2-1 over Brazil turns those picks into a huge bracket moment 🔥',
      },
      {
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'BRA',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-1 לנורווגיה, הבראקט הזה צריך תשובה טובה בצ׳אט 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-1 לנורווגיה, הבראקטים האלה צריכים תשובה טובה בצ׳אט 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-1 לנורווגיה, הבראקטים האלה צריכים תשובה טובה בצ׳אט 😬',
        en_name: '{names} picked {team} to advance in the knockout bracket. After Norway’s 2-1, that bracket needs a strong chat answer 😬',
        en_names: '{names} picked {team} to advance in the knockout bracket. After Norway’s 2-1, those brackets need strong chat answers 😬',
        en_count: '{names} picked {team} to advance in the knockout bracket. After Norway’s 2-1, those brackets need strong chat answers 😬',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'BRA',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי שנורווגיה שלחה אותה הביתה, זה רגע של ידיים על הראש 😬',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי שנורווגיה שלחה אותה הביתה, זה רגע של ידיים על הראש 😬',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי שנורווגיה שלחה אותה הביתה, זה רגע של ידיים על הראש 😬',
    ...
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'ENG',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. הצמד המאוחר של קיין הפך את הבחירה הזו לקבלה אמיתית בבראקט 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. הצמד המאוחר של קיין הפך את הבחירות האלה לקבלות אמיתיות בבראקט 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. הצמד המאוחר של קיין הפך את הבחירות האלה לקבלות אמיתיות בבראקט 🔥',
        en_name: "{names} picked {team} to advance in the knockout bracket. Kane's late double turns that pick into a proper bracket receipt 🔥",
        en_names: "{names} picked {team} to advance in the knockout bracket. Kane's late double turns those picks into proper bracket receipts 🔥",
        en_count: "{names} picked {team} to advance in the knockout bracket. Kane's late double turns those picks into proper bracket receipts 🔥",
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'ENG',
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'COD',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי המהפך של קיין, הבחירה הזו צריכה נאום הגנה קצר בצאט 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי המהפך של קיין, הבחירות האלה צריכות נאום הגנה קצר בצאט 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי המהפך של קיין, הבחירות האלה צריכות נאום הגנה קצר בצאט 😬',
        en_name: "{names} picked {team} to advance in the knockout bracket. After Kane's turnaround, that pick needs a short defense speech in the chat 😬",
        en_names: "{names} picked {team} to advance in the knockout bracket. After Kane's turnaround, those picks need short defense speeches in the chat 😬",
        en_count: "{names} picked {team} to advance in the knockout bracket. After Kane's turnaround, those picks need short defense speeches in the chat 😬",
      },
    ],
  },
  'BEL-SEN': {
    ...
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'BEL',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. קאמבק מ-2-0 ל-3-2 הופך את הבחירה הזו לקלף ענק 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. קאמבק מ-2-0 ל-3-2 הופך את הבחירות האלה לקלפים ענקיים 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. קאמבק מ-2-0 ל-3-2 הופך את הבחירות האלה לקלפים ענקיים 🔥',
        en_name: '{names} picked {team} to advance in the knockout bracket. A comeback from 2-0 down to 3-2 turns that pick into a monster card 🔥',
        en_names: '{names} picked {team} to advance in the knockout bracket. A comeback from 2-0 down to 3-2 turns those picks into monster cards 🔥',
        en_count: '{names} picked {team} to advance in the knockout bracket. A comeback from 2-0 down to 3-2 turns those picks into monster cards 🔥',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'BEL',
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'SEN',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי 3-2 כזה לבלגיה, זה רגע של ידיים על הראש 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 3-2 כזה לבלגיה, זה רגע של ידיים על הראש 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 3-2 כזה לבלגיה, זה רגע של ידיים על הראש 😬',
        en_name: '{names} picked {team} to advance in the knockout bracket. After that 3-2 for Belgium, this is a hands-on-head moment 😬',
        en_names: '{names} picked {team} to advance in the knockout bracket. After that 3-2 for Belgium, these are hands-on-head moments 😬',
        en_count: '{names} picked {team} to advance in the knockout bracket. After that 3-2 for Belgium, these are hands-on-head moments 😬',
      },
    ],
  },
  'USA-BIH': {
    ...
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'USA',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. 2-0 בעשרה שחקנים הופך את הבחירה הזו לקבלה חזקה במיוחד 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-0 בעשרה שחקנים הופך את הבחירות האלה לקבלות חזקות במיוחד 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-0 בעשרה שחקנים הופך את הבחירות האלה לקבלות חזקות במיוחד 🔥',
        en_name: '{names} picked {team} to advance in the knockout bracket. A 2-0 with ten men turns that pick into a serious receipt 🔥',
        en_names: '{names} picked {team} to advance in the knockout bracket. A 2-0 with ten men turns those picks into serious receipts 🔥',
        en_count: '{names} picked {team} to advance in the knockout bracket. A 2-0 with ten men turns those picks into serious receipts 🔥',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'USA',
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'BIH',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. 2-0 לארהב בעשרה שחקנים הופך את הבחירה הזו לכואבת במיוחד 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-0 לארהב בעשרה שחקנים הופך את הבחירות האלה לכואבות במיוחד 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-0 לארהב בעשרה שחקנים הופך את הבחירות האלה לכואבות במיוחד 😬',
        en_name: '{names} picked {team} to advance in the knockout bracket. A 2-0 to ten-man USA makes that pick hurt even more 😬',
        en_names: '{names} picked {team} to advance in the knockout bracket. A 2-0 to ten-man USA makes those picks hurt even more 😬',
        en_count: '{names} picked {team} to advance in the knockout bracket. A 2-0 to ten-man USA makes those picks hurt even more 😬',
      },
    ],
  },
  'USA-BEL': {
    ...
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'NOR',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. 2-1 על חוף השנהב הפך את הבחירה הזאת לקלף אמיתי לשלב הבא 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-1 על חוף השנהב הפך את הבחירות האלה לקלפים אמיתיים לשלב הבא 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-1 על חוף השנהב הפך את הבחירות האלה לקלפים אמיתיים לשלב הבא 🔥',
        en_name: '{names} picked {team} to advance in the knockout bracket. A 2-1 win over Ivory Coast turns that pick into a real next-round card 🔥',
        en_names: '{names} picked {team} to advance in the knockout bracket. A 2-1 win over Ivory Coast turns those picks into real next-round cards 🔥',
        en_count: '{names} picked {team} to advance in the knockout bracket. A 2-1 win over Ivory Coast turns those picks into real next-round cards 🔥',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'NOR',
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'CIV',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-1 לנורווגיה, הבחירה הזאת צריכה הסבר טוב בצ׳אט 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-1 לנורווגיה, הבחירות האלה צריכות הסבר טוב בצ׳אט 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-1 לנורווגיה, הבחירות האלה צריכות הסבר טוב בצ׳אט 😬',
        en_name: '{names} picked {team} to advance in the knockout bracket. After Norway’s 2-1, that pick needs a strong answer in the chat 😬',
        en_names: '{names} picked {team} to advance in the knockout bracket. After Norway’s 2-1, those picks need strong answers in the chat 😬',
        en_count: '{names} picked {team} to advance in the knockout bracket. After Norway’s 2-1, those picks need strong answers in the chat 😬',
      },
    ],
  },
  'FRA-SWE': {
    ...
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'FRA',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. 3-0 על שוודיה זו לא בחירה זהירה, זו חותמת 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 3-0 על שוודיה אלה לא בחירות זהירות, אלה חותמות 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 3-0 על שוודיה אלה לא בחירות זהירות, אלה חותמות 🔥',
        en_name: '{names} picked {team} to advance in the knockout bracket. A 3-0 over Sweden is not cautious; it is a stamp 🔥',
        en_names: '{names} picked {team} to advance in the knockout bracket. A 3-0 over Sweden is not cautious; it is a stamp 🔥',
        en_count: '{names} picked {team} to advance in the knockout bracket. A 3-0 over Sweden is not cautious; it is a stamp 🔥',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'FRA',
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'SWE',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי 3-0 לצרפת, הבחירה הזאת צריכה תשובה טובה בצ׳אט 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 3-0 לצרפת, הבחירות האלה צריכות תשובה טובה בצ׳אט 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 3-0 לצרפת, הבחירות האלה צריכות תשובה טובה בצ׳אט 😬',
        en_name: '{names} picked {team} to advance in the knockout bracket. After France’s 3-0, that pick needs a better answer in the chat 😬',
        en_names: '{names} picked {team} to advance in the knockout bracket. After France’s 3-0, those picks need better answers in the chat 😬',
        en_count: '{names} picked {team} to advance in the knockout bracket. After France’s 3-0, those picks need better answers in the chat 😬',
      },
    ],
  },
  'MEX-ECU': {
    ...
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'MEX',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. 2-0 על אקוודור הופך את הבחירה הזאת לרגע אישי בהימור 🔥',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-0 על אקוודור הופך את הבחירות האלה לרגעים אישיים בהימור 🔥',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. 2-0 על אקוודור הופך את הבחירות האלה לרגעים אישיים בהימור 🔥',
        en_name: '{names} picked {team} to advance in the knockout bracket. A 2-0 over Ecuador turns that pick into a personal pool moment 🔥',
        en_names: '{names} picked {team} to advance in the knockout bracket. A 2-0 over Ecuador turns those picks into personal pool moments 🔥',
        en_count: '{names} picked {team} to advance in the knockout bracket. A 2-0 over Ecuador turns those picks into personal pool moments 🔥',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'MEX',
      ...
      },
      {
        table: 'knockout_picks',
        team_code: 'ECU',
        he_name: '{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-0 למקסיקו, הצ׳אט קיבל שאלה קשה 😬',
        he_names: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-0 למקסיקו, הצ׳אט קיבל שאלה קשה 😬',
        he_count: '{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי 2-0 למקסיקו, הצ׳אט קיבל שאלה קשה 😬',
        en_name: '{names} picked {team} to advance in the knockout bracket. After Mexico’s 2-0, the chat has a hard question to answer 😬',
        en_names: '{names} picked {team} to advance in the knockout bracket. After Mexico’s 2-0, the chat has hard questions to answer 😬',
        en_count: '{names} picked {team} to advance in the knockout bracket. After Mexico’s 2-0, the chat has hard questions to answer 😬',
      },
    ],
  },
  'MEX-KOR': {
  ...
  'IRQ-NOR': {
    caption: {
      he: 'הולאנד ונורווגיה הפכו את זה ל-4-1 על עיראק, ופתאום בית I נראה כמו מקום שלא כדאי להגיע אליו בלי קסדה ⚡',
    ...
    pool_focuses: [
      ...
      },
      {
        ...
        team_code: 'IRQ',
        position: 1,
        he_name: 'זה היה מביך... {names} שם את {team} ראשונה בבית. אחרי 4-1 מנורווגיה, אפשר לקרוע את הטופס או למסגר אותו כמזכרת 🧾',
        he_names: 'זה היה מביך... {names} שמו את {team} ראשונה בבית. אחרי 4-1 מנורווגיה, אפשר לקרוע את הטפסים או למסגר אותם כמזכרת 🧾',
        he_count: 'זה היה מביך... {names} שמו את {team} ראשונה בבית. אחרי 4-1 מנורווגיה, אפשר לקרוע את הטפסים או למסגר אותם כמזכרת 🧾',
...
function knockoutFocus(match, outcome, teamCode) {
  ...
  const won = teamCode === outcome;
  const copy = won ? {
    heName: `{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי ${score} מול ${opponentHe}, הבחירה הזאת נכנסה לשיחה על השלב הבא ⚽`,
    heNames: `{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי ${score} מול ${opponentHe}, אלה כבר לא טפסים - אלה קבלות חיות ⚽`,
    enName: `{names} picked {team} to advance in the knockout bracket. After ${score} against ${opponentEn}, that pick goes straight into the next-round conversation ⚽`,
    enNames: `{names} picked {team} to advance in the knockout bracket. After ${score} against ${opponentEn}, those picks go straight into the next-round conversation ⚽`,
  } : {
    heName: `{names} בחר את {team} להתקדם בבראקט הנוקאאוט. אחרי ${score} ב${stageHe}, ההימור הזה כבר עומד מול המציאות ⚽`,
    heNames: `{names} בחרו את {team} להתקדם בבראקט הנוקאאוט. אחרי ${score} ב${stageHe}, ההימורים האלה כבר עומדים מול המציאות ⚽`,
    enName: `{names} picked {team} to advance in the knockout bracket. After ${score} in the ${stageEn}, that pick needs a serious answer now ⚽`,
    enNames: `{names} picked {team} to advance in the knockout bracket. After ${score} in the ${stageEn}, those picks need serious answers now ⚽`,
  };
  return {
    table: 'knockout_picks',
    team_code: teamCode,
