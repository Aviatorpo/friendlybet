...
const STORY_COPY_OVERRIDES = {
  'CIV-NOR': {
    caption: {
      he: 'נורבגיה עברה את חוף השנהב עם 2-1 בשמינית-מוקדמת. הולאנד והבראקט נשארים בחיים, וחוף השנהב נפרדת מוקדם מדי ⚽',
      en: 'Norway got through Ivory Coast 2-1 in the Round of 32. Haaland and the bracket stay alive, and Ivory Coast exits too early ⚽',
    },
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'NOR',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 על חוף השנהב, הטופס הזה נראה קר יותר מקרח נורבגי 🧊',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 על חוף השנהב, הטפסים האלה נראים קרירים ומדויקים 🧊',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 על חוף השנהב, הטפסים האלה נראים קרירים ומדויקים 🧊',
        en_name: '{names} picked {team} to win this knockout match. After 2-1 over Ivory Coast, that form looks ice cold 🧊',
        en_names: '{names} picked {team} to win this knockout match. After 2-1 over Ivory Coast, those forms look ice cold 🧊',
        en_count: '{names} picked {team} to win this knockout match. After 2-1 over Ivory Coast, those forms look ice cold 🧊',
      },
      {
        table: 'knockout_picks',
        team_code: 'CIV',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 לנורבגיה, ההימור הזה קיבל סיום חד מדי 😬',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 לנורבגיה, ההימורים האלה קיבלו סיום חד מדי 😬',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 לנורבגיה, ההימורים האלה קיבלו סיום חד מדי 😬',
        en_name: '{names} picked {team} to win this knockout match. After Norway made it 2-1, that pick ran out of road 😬',
        en_names: '{names} picked {team} to win this knockout match. After Norway made it 2-1, those picks ran out of road 😬',
        en_count: '{names} picked {team} to win this knockout match. After Norway made it 2-1, those picks ran out of road 😬',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'NOR',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי 2-1 בנוקאאוט, החלום על הגביע עדיין עומד על הרגליים 🏆',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-1 בנוקאאוט, החלום על הגביע עדיין עומד על הרגליים 🏆',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-1 בנוקאאוט, החלום על הגביע עדיין עומד על הרגליים 🏆',
        en_name: '{names} picked {team} to win the World Cup. After a 2-1 knockout win, that trophy dream is still standing 🏆',
        en_names: '{names} picked {team} to win the World Cup. After a 2-1 knockout win, those trophy dreams are still standing 🏆',
        en_count: '{names} picked {team} to win the World Cup. After a 2-1 knockout win, those trophy dreams are still standing 🏆',
      },
    ],
  },
  'FRA-SWE': {
    caption: {
      he: 'צרפת עברה את שוודיה עם 3-0 נקי בשמינית-מוקדמת. זו לא רק העפלה, זו אזהרה ליריבה הבאה בצד השני של הבראקט ⚡',
      en: 'France cleared Sweden 3-0 in the Round of 32. This is not just qualification, it is a warning to whoever waits next in the bracket ⚡',
    },
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'FRA',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 על שוודיה, הטופס הזה נראה כמו מסלול מהיר ⚡',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 על שוודיה, הטפסים האלה נראים כמו מסלול מהיר ⚡',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 על שוודיה, הטפסים האלה נראים כמו מסלול מהיר ⚡',
        en_name: '{names} picked {team} to win this knockout match. After 3-0 over Sweden, that form looks like the fast lane ⚡',
        en_names: '{names} picked {team} to win this knockout match. After 3-0 over Sweden, those forms look like the fast lane ⚡',
        en_count: '{names} picked {team} to win this knockout match. After 3-0 over Sweden, those forms look like the fast lane ⚡',
      },
      {
        table: 'knockout_picks',
        team_code: 'SWE',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 לצרפת, ההימור הזה קיבל לילה קשה 😬',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 לצרפת, ההימורים האלה קיבלו לילה קשה 😬',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 לצרפת, ההימורים האלה קיבלו לילה קשה 😬',
        en_name: '{names} picked {team} to win this knockout match. After France made it 3-0, that pick had a rough night 😬',
        en_names: '{names} picked {team} to win this knockout match. After France made it 3-0, those picks had a rough night 😬',
        en_count: '{names} picked {team} to win this knockout match. After France made it 3-0, those picks had a rough night 😬',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'FRA',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי 3-0 בנוקאאוט, הצ\'אט צריך להתייחס לזה ברצינות 🔥',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 3-0 בנוקאאוט, הצ\'אט צריך להתייחס לזה ברצינות 🔥',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 3-0 בנוקאאוט, הצ\'אט צריך להתייחס לזה ברצינות 🔥',
        en_name: '{names} picked {team} to win the World Cup. After a 3-0 knockout win, the chat has to take that seriously 🔥',
        en_names: '{names} picked {team} to win the World Cup. After a 3-0 knockout win, the chat has to take those picks seriously 🔥',
        en_count: '{names} picked {team} to win the World Cup. After a 3-0 knockout win, the chat has to take those picks seriously 🔥',
      },
    ],
  },
  'MEX-ECU': {
    caption: {
      he: 'מקסיקו עברה את אקוודור עם 2-0 בשמינית-מוקדמת. המארחת ממשיכה הלאה, והבראקט מקבל עוד משחק עם רעש אמיתי 🔥',
      en: 'Mexico got past Ecuador 2-0 in the Round of 32. The hosts move on, and the bracket gets another match with real noise 🔥',
    },
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'MEX',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 על אקוודור, הטופס הזה מרגיש מאוד בבית 🔥',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 על אקוודור, הטפסים האלה מרגישים מאוד בבית 🔥',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 על אקוודור, הטפסים האלה מרגישים מאוד בבית 🔥',
        en_name: '{names} picked {team} to win this knockout match. After 2-0 over Ecuador, that form feels right at home 🔥',
        en_names: '{names} picked {team} to win this knockout match. After 2-0 over Ecuador, those forms feel right at home 🔥',
        en_count: '{names} picked {team} to win this knockout match. After 2-0 over Ecuador, those forms feel right at home 🔥',
      },
      {
        table: 'knockout_picks',
        team_code: 'ECU',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 למקסיקו, ההימור הזה פגש קיר ירוק 😬',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 למקסיקו, ההימורים האלה פגשו קיר ירוק 😬',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 למקסיקו, ההימורים האלה פגשו קיר ירוק 😬',
        en_name: '{names} picked {team} to win this knockout match. After Mexico made it 2-0, that pick hit a green wall 😬',
        en_names: '{names} picked {team} to win this knockout match. After Mexico made it 2-0, those picks hit a green wall 😬',
        en_count: '{names} picked {team} to win this knockout match. After Mexico made it 2-0, those picks hit a green wall 😬',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'MEX',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי 2-0 בנוקאאוט, זה כבר נשמע פחות כמו חלום ביתי ויותר כמו אזהרה 🏆',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-0 בנוקאאוט, זה כבר נשמע פחות כמו חלום ביתי ויותר כמו אזהרה 🏆',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-0 בנוקאאוט, זה כבר נשמע פחות כמו חלום ביתי ויותר כמו אזהרה 🏆',
        en_name: '{names} picked {team} to win the World Cup. After a 2-0 knockout win, that sounds less like home dreaming and more like a warning 🏆',
        en_names: '{names} picked {team} to win the World Cup. After a 2-0 knockout win, those sound less like home dreams and more like warnings 🏆',
        en_count: '{names} picked {team} to win the World Cup. After a 2-0 knockout win, those sound less like home dreams and more like warnings 🏆',
      },
    ],
  },
  'MEX-KOR': {
