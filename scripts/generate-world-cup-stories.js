...
const STORY_COPY_OVERRIDES = {
  'MEX-ECU': {
    title: {
      he: 'מקסיקו ניצחה את אקוודור 2-0: הנוקאאוט ממשיך בירוק',
      en: 'Mexico beat Ecuador 2-0: the knockout rolls on in green',
    },
    caption: {
      he: 'מקסיקו עברה את אקוודור 2-0 בנוקאאוט עם הופעה חדה, נקייה, ומקום בשלב הבא 🔥',
      en: 'Mexico beat Ecuador 2-0 in the knockouts with a sharp, clean performance and a place in the next round 🔥',
    },
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'MEX',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 על אקוודור, הטופס הזה מרגיש חד מאוד 🔥',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 על אקוודור, הטפסים האלה מרגישים חדים מאוד 🔥',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 על אקוודור, הטפסים האלה מרגישים חדים מאוד 🔥',
        en_name: '{names} picked {team} to win this knockout match. After 2-0 over Ecuador, that form looks very sharp 🔥',
        en_names: '{names} picked {team} to win this knockout match. After 2-0 over Ecuador, those forms look very sharp 🔥',
        en_count: '{names} picked {team} to win this knockout match. After 2-0 over Ecuador, those forms look very sharp 🔥',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'MEX',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי 2-0 על אקוודור, החלום הזה קיבל הוכחה ראשונה 🔥',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-0 על אקוודור, החלום הזה קיבל הוכחה ראשונה 🔥',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-0 על אקוודור, החלום הזה קיבל הוכחה ראשונה 🔥',
        en_name: '{names} picked {team} to win the World Cup. After 2-0 over Ecuador, that dream has its first proof 🔥',
        en_names: '{names} picked {team} to win the World Cup. After 2-0 over Ecuador, those dreams have their first proof 🔥',
        en_count: '{names} picked {team} to win the World Cup. After 2-0 over Ecuador, those dreams have their first proof 🔥',
      },
      {
        table: 'knockout_picks',
        team_code: 'ECU',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 ממקסיקו, הטופס הזה קיבל ערב לא קל 😬',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 ממקסיקו, הטפסים האלה קיבלו ערב לא קל 😬',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-0 ממקסיקו, הטפסים האלה קיבלו ערב לא קל 😬',
        en_name: '{names} picked {team} to win this knockout match. After 2-0 from Mexico, that form had a rough night 😬',
        en_names: '{names} picked {team} to win this knockout match. After 2-0 from Mexico, those forms had a rough night 😬',
        en_count: '{names} picked {team} to win this knockout match. After 2-0 from Mexico, those forms had a rough night 😬',
      },
    ],
  },
  'FRA-SWE': {
    title: {
      he: 'צרפת ניצחה את שוודיה 3-0: הדרך לשלב הבא נפתחה',
      en: 'France beat Sweden 3-0: the next round is open',
    },
    caption: {
      he: 'צרפת דרסה את שוודיה 3-0 ועלתה שלב עם משחק שהרגיש חד מהרגע הראשון ⚡',
      en: 'France rolled past Sweden 3-0 and moved on with a match that felt sharp from the first whistle ⚡',
    },
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'FRA',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 על שוודיה, זה נראה כמו מסלול מהיר ⚡',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 על שוודיה, זה נראה כמו מסלול מהיר ⚡',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 על שוודיה, זה נראה כמו מסלול מהיר ⚡',
        en_name: '{names} picked {team} to win this knockout match. After 3-0 over Sweden, that looks like the fast lane ⚡',
      ...
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'FRA',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי 3-0 על שוודיה, הטופס הזה כבר מדבר בקול רם ⚡',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 3-0 על שוודיה, הטפסים האלה כבר מדברים בקול רם ⚡',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 3-0 על שוודיה, הטפסים האלה כבר מדברים בקול רם ⚡',
        en_name: '{names} picked {team} to win the World Cup. After 3-0 over Sweden, that form is speaking loudly now ⚡',
        en_names: '{names} picked {team} to win the World Cup. After 3-0 over Sweden, those forms are speaking loudly now ⚡',
        en_count: '{names} picked {team} to win the World Cup. After 3-0 over Sweden, those forms are speaking loudly now ⚡',
      },
      {
        table: 'knockout_picks',
        team_code: 'SWE',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 מצרפת, הטופס הזה נראה מאוד לבד 😬',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 מצרפת, הטפסים האלה נראים מאוד לבד 😬',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 3-0 מצרפת, הטפסים האלה נראים מאוד לבד 😬',
        en_name: '{names} picked {team} to win this knockout match. After 3-0 from France, that form looks very lonely 😬',
        en_names: '{names} picked {team} to win this knockout match. After 3-0 from France, those forms look very lonely 😬',
        en_count: '{names} picked {team} to win this knockout match. After 3-0 from France, those forms look very lonely 😬',
      },
    ],
  },
  'CIV-NOR': {
    title: {
      he: 'נורבגיה ניצחה את חוף השנהב 2-1: קרח בנוקאאוט',
      en: 'Norway beat Ivory Coast 2-1: ice in the knockout',
    },
    caption: {
      he: 'נורבגיה עברה את חוף השנהב 2-1 בנוקאאוט צמוד, קר ומדויק עד הסוף 🧊',
      en: 'Norway beat Ivory Coast 2-1 in a tight knockout match that stayed cold and clean to the end 🧊',
    },
    pool_focuses: [
      {
        table: 'knockout_picks',
        team_code: 'NOR',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 על חוף השנהב, הטופס הזה קר כמו קרח 🧊',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 על חוף השנהב, הטפסים האלה קרים כמו קרח 🧊',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 על חוף השנהב, הטפסים האלה קרים כמו קרח 🧊',
        en_name: '{names} picked {team} to win this knockout match. After 2-1 over Ivory Coast, that form is ice cold 🧊',
        en_names: '{names} picked {team} to win this knockout match. After 2-1 over Ivory Coast, those forms are ice cold 🧊',
        en_count: '{names} picked {team} to win this knockout match. After 2-1 over Ivory Coast, those forms are ice cold 🧊',
      },
      {
        table: 'tournament_winner_picks',
        team_code: 'NOR',
        he_name: '{names} בחר את {team} כמנצחת המונדיאל. אחרי 2-1 על חוף השנהב, זה כבר לא נשמע רומנטי אלא מסוכן 🧊',
        he_names: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-1 על חוף השנהב, זה כבר לא נשמע רומנטי אלא מסוכן 🧊',
        he_count: '{names} בחרו את {team} כמנצחת המונדיאל. אחרי 2-1 על חוף השנהב, זה כבר לא נשמע רומנטי אלא מסוכן 🧊',
        en_name: '{names} picked {team} to win the World Cup. After 2-1 over Ivory Coast, that sounds less romantic and more dangerous 🧊',
        en_names: '{names} picked {team} to win the World Cup. After 2-1 over Ivory Coast, those forms sound less romantic and more dangerous 🧊',
        en_count: '{names} picked {team} to win the World Cup. After 2-1 over Ivory Coast, those forms sound less romantic and more dangerous 🧊',
      },
      {
        table: 'knockout_picks',
        team_code: 'CIV',
        he_name: '{names} בחר את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 מנורבגיה, הטופס הזה כבר מחפש תירוץ 😬',
        he_names: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 מנורבגיה, הטפסים האלה כבר מחפשים תירוץ 😬',
        he_count: '{names} בחרו את {team} לנצח במשחק הנוקאאוט הזה. אחרי 2-1 מנורבגיה, הטפסים האלה כבר מחפשים תירוץ 😬',
        en_name: '{names} picked {team} to win this knockout match. After 2-1 from Norway, that form is already looking for an excuse 😬',
        en_names: '{names} picked {team} to win this knockout match. After 2-1 from Norway, those forms are already looking for excuses 😬',
        en_count: '{names} picked {team} to win this knockout match. After 2-1 from Norway, those forms are already looking for excuses 😬',
      },
    ],
  },
  'MEX-KOR': {
