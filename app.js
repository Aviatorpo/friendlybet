...
async function buildPoolPundit() {
  ...
  push('pool-ev-compare', 12, [{
    he: 'השווה את הבראקט שלך מול שאר החברים בהימור. עכשיו כל מעבר שלב משנה את הסיפור 📊',
    en: 'Compare your bracket against the rest of your pool. Every team that moves on changes the story 📊' }]);
...
const _PP_EVERGREEN = [
  ...
  { id: 'ev-darkhorse', he: 'אל תזלזלו באאוטסיידרים — בנוקאאוט משחק אחד יכול למחוק בראקט שלם 👀',
    en: 'Do not sleep on outsiders — in the knockouts one match can wreck a whole bracket 👀' },
  ...
  { id: 'ev-everypick', he: 'כל בחירה שנשארה בחיים בבראקט שווה לחץ חדש. אל תתאהבו בתחזית אחת ✍️',
    en: 'Every surviving bracket pick brings fresh pressure. Do not fall too hard for one prediction ✍️' },
  ...
  { id: 'ev-r32', he: 'לראשונה בהיסטוריה יש שלב נוקאאוט של 32 קבוצות. יותר משחקי הדחה, יותר קבלות לבראקט 🗺️',
    en: 'For the first time ever there is a Round of 32. More elimination matches, more bracket receipts 🗺️' },
  { id: 'ev-bracket-path', he: 'בראקט טוב הוא לא רק אלופה נכונה — הוא סדרת הישרדות, סיבוב אחרי סיבוב 👌',
    en: 'A good bracket is not only the right champion — it is survival, round by round 👌' },
  ...
  { id: 'ev-next-whistle', he: 'בשלב הזה שריקה אחת יכולה להפוך מוביל לרודף. זה היופי האכזרי של בראקט ⚽',
    en: 'At this stage one whistle can turn a leader into a chaser. That is the cruel beauty of a bracket ⚽' },
  ...
  { id: 'ev-host-auto', he: 'שלוש המארחות עדיין על הבמה של 2026. מי מהן בנויה לריצה אמיתית? 🏠',
    en: 'The three hosts are still part of the 2026 story. Which one is built for a real run? 🏠' },
  ...
  { id: 'ev-upsets', he: 'בנוקאאוט אין הפתעות קטנות. כל הדחה גדולה מגיעה ישר ללידרבורד 👀',
    en: 'In the knockouts there are no small upsets. Every big exit goes straight to the leaderboard 👀' },
  { id: 'ev-r32-receipts', he: 'סיבוב 32 הוא מבחן עצבים: מי שעובר כאן נותן לבראקט עוד חמצן 🧾',
    en: 'The Round of 32 is a nerve test: every survivor gives a bracket more oxygen 🧾' },
  { id: 'ev-ko-draws', he: 'תוצאה שוויונית בנוקאאוט היא לא סוף הסיפור. מה שקובע הוא מי באמת עולה הלאה 🎟️',
    en: 'A level score in the knockouts is not the whole story. What matters is who actually advances 🎟️' },
  { id: 'ev-chase', he: 'מי שמוביל צריך לשמור על קור רוח. מי שרודף צריך משחק אחד שיפתח הכול 🏃',
    en: 'The leader needs calm. The chasers need one match that cracks everything open 🏃' },
  { id: 'ev-champion-alive', he: 'בחירת האלופה עדיין חיה? אז ההימור שלך עדיין מחזיק חלום גדול 🏆',
    en: 'Is your champion pick still alive? Then your pool still has a big dream attached 🏆' },
  { id: 'ev-clean-sheet', he: 'בנוקאאוט, משחק נקי בהגנה יכול להיות שווה יותר מעוד תחזית יפה על הנייר 🧤',
    en: 'In the knockouts, one clean defensive night can be worth more than a pretty prediction on paper 🧤' },
  { id: 'ev-late-goals', he: 'שער מאוחר בשלב הזה לא רק משנה משחק. הוא משנה מצב רוח של כל ההימור ⏱️',
    en: 'A late goal at this stage does not only change a match. It changes the whole pool mood ⏱️' },
  { id: 'ev-bracket-swing', he: 'בראקטים לא נופלים לאט. לפעמים משחק אחד מפיל חצי תחזית בבת אחת 🧨',
    en: 'Brackets do not always collapse slowly. Sometimes one match drops half a prediction at once 🧨' },
  { id: 'ev-survive-advance', he: 'בשלבי הדחה, יפה פחות חשוב מנכון. לשרוד ולעלות זה כל הסיפור 🎯',
    en: 'In elimination rounds, pretty matters less than correct. Survive and advance is the whole story 🎯' },
  { id: 'ev-table-pressure', he: 'הלידרבורד נראה יציב רק עד השריקה הבאה. אחריה כולם עושים חישובים מחדש 📈',
    en: 'The leaderboard looks stable only until the next whistle. After that, everyone recalculates 📈' },
  { id: 'ev-penalty-nerves', he: 'אם משחק מגיע לשובר שוויון, הלב של הבראקט עובד שעות נוספות 🥶',
    en: 'If a match reaches a tiebreaker, the bracket heartbeat starts working overtime 🥶' },
  { id: 'ev-one-pick', he: 'לפעמים בחירה אחת נכונה בנוקאאוט שווה יותר מחמישה הסברים אחרי המשחק 🔍',
    en: 'Sometimes one correct knockout pick is worth more than five explanations after the match 🔍' },
];
...
function _matchUxState(m, now = Date.now()) {
  ...
  if (_matchNeedsStatusVerification(m, now)) {
    ...
    return {
      ...
      noteKey: hasNumericScore ? 'matchesEx.liveStatusUpdatingNote' : 'matchesEx.liveFeedConnectingNote',
      requiresVerification: true,
      isLive: false,
      isFinished: false,
      isScheduled: false,
  ...
  if (_matchIsLiveish(m, now)) {
    ...
    if (!liveScoreTrusted) {
      return {
        ...
        className: 'live',
        statusKey: 'matchesEx.live',
        noteKey: 'matchesEx.liveFeedConnectingNote',
        requiresVerification: false,
        isLive: true,
        isFinished: false,
        isScheduled: false,
...
function _groupsCompleteLeaderboardBanter(users) {
  ...
  const headline = name && pts > 0
    ...
    : {
        ...
        type: 'groups-complete',
        emoji: '🏁',
        he: 'הנוקאאוט כבר רץ. מכאן הלידרבורד זז דרך הבראקט, האלופה ומלך השערים.',
        en: 'The knockouts are underway. From here the leaderboard moves through the bracket, champion pick, and top scorer.',
      };
  return {
    ...
    items: [
      headline,
      {
        ...
        emoji: '🎯',
        he: 'מי שמאחור צריך פגיעות נוקאאוט עכשיו. מי שמוביל צריך שכל בחירה בבראקט תחזיק מעמד.',
        en: 'Anyone behind needs knockout hits now. Anyone leading needs every bracket pick to hold.',
      },
    ],
  };
}
