// Generated by scripts/generate-third-place-allocation.js from source-data/third-place-table.tsv.
// Source table mirrors FIFA World Cup 2026 Regulations Annex C.
export const SP_THIRD_PLACE_ALLOCATION_SOURCE = "source-data/third-place-table.tsv";
export const SP_THIRD_PLACE_POSITION_ORDER = Object.freeze([2,5,7,8,9,10,13,15]);
export const SP_THIRD_PLACE_ALLOCATION_ROWS = Object.freeze({
  "ABCDEFGH": "CFHEBAGD",
  "ABCDEFGI": "DFCIBAGE",
  "ABCDEFGJ": "DFCJBAGE",
  "ABCDEFGK": "DFCKBAGE",
