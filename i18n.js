...
const TRANSLATIONS = {
  he: {
    ...
    'reopen.championLocked': 'האלופה שלך ({team}) נעולה — בנה בראקט שבו היא מגיעה לגמר ומנצחת.',
  ...
  en: {
    ...
    'reopen.championLocked': 'Your champion ({team}) is locked — build a bracket where they reach the final and win it.',
