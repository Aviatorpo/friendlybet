...
const TRANSLATIONS = {
  he: {
    ...
    'reopen.user.preKickoffSubPool': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך לא מסומן כשבור, אבל כדי לשמור על הוגנות כל חברי הפול קיבלו את אותו חלון בדיקה כי חלק מהחברים צריכים זמן נוסף. אפשר לבדוק/לערוך את הנוקאאוט עכשיו; בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות.',
    ...
    'reopen.user.approvedSubPool': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך לא מסומן כשבור, אבל כדי לשמור על הוגנות כל חברי הפול קיבלו את אותו חלון בדיקה כי חלק מהחברים צריכים זמן נוסף. אפשר לבדוק/לערוך את הנוקאאוט עכשיו; בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
  ...
  en: {
    ...
    'reopen.user.preKickoffSubPool': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is not flagged as broken, but for fairness everyone in this affected pool gets the same knockout review window because some members need extra time. You can review/edit knockout now; picks that do not match the corrected official bracket will score 0 points.',
    ...
    'reopen.user.approvedSubPool': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is not flagged as broken, but for fairness everyone in this affected pool gets the same knockout review window because some members need extra time. You can review/edit knockout now; picks that do not match the corrected official bracket will score 0 points. Your group picks, third-place teams, and top scorer stay locked.',
