...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.tpR16Incident.title': 'חשוב: צריך למלא מחדש את שלב הנוקאאוט',
    'dashboard.tpR16Incident.sub': 'אנחנו מתנצלים מאוד. בעקבות תקלה אצלנו, בזמן שמילאת את הבראקט חלק ממשחקי הנוקאאוט שובצו לא נכון. תיקנו את השיבוץ לפי חוקי FIFA. כדי שהבחירות שלך יתאימו לבראקט הרשמי, בבקשה מלא/י מחדש את שלב הנוקאאוט.',
    'dashboard.tpR16Incident.pointsRisk': 'אם לא תמלא/י מחדש, חלק מהבחירות הקיימות עלולות לא להתאים למשחקים המתוקנים ולא תקבל/י עליהן נקודות.',
    'dashboard.tpR16Incident.cta': 'למלא מחדש את הנוקאאוט',
    'dashboard.tpR16Incident.adminTitle': 'חשוב: חלק מהמשתתפים מילאו בראקט לא מדויק',
    'dashboard.tpR16Incident.adminSub': 'אנחנו מתנצלים מאוד. בגלל תקלה אצלנו, חלק מהמשתתפים בפול שלך מילאו את שלב הנוקאאוט בזמן שהבראקט לא היה משובץ נכון. תיקנו את השיבוץ לפי חוקי FIFA.',
    'dashboard.tpR16Incident.adminPointsRisk': 'כדאי לוודא שכל המשתתפים שמילאו לפני התיקון נכנסים שוב וממלאים מחדש את הנוקאאוט כל עוד הוא פתוח, עד תחילת שלב הנוקאאוט. מי שלא ימלא מחדש עלול לפספס נקודות.',
    'dashboard.tpR16Incident.adminCta': 'לראות משתתפים',
    'dashboard.tpR16Incident.copy': 'העתק הודעה לקבוצה',
    'dashboard.tpR16Incident.copyMessage': 'היי, FriendlyBet מתנצלת מאוד: הייתה תקלה בשיבוץ שלב הנוקאאוט בחלק מהבראקטים שמולאו היום. התקלה תוקנה לפי חוקי FIFA. אם כבר מילאתם את הנוקאאוט לפני התיקון, בבקשה היכנסו ומלאו מחדש את שלב הנוקאאוט: {link}. מי שלא ימלא מחדש עלול לפספס נקודות.',
    'dashboard.tpR16IncidentClosed.title': 'חשוב: חלון מילוי הנוקאאוט נסגר',
    'dashboard.tpR16IncidentClosed.sub': 'אנחנו מתנצלים מאוד. הבראקט שלך מולא לפני שתיקנו את שיבוץ הנוקאאוט לפי חוקי FIFA, וכעת שלב הנוקאאוט כבר נעול לעריכה.',
    'dashboard.tpR16IncidentClosed.pointsRisk': 'חלק מהבחירות הישנות עלולות לא להתאים למשחקים המתוקנים, ולכן ייתכן שלא יתקבלו עליהן נקודות.',
    'dashboard.tpR16IncidentClosed.adminTitle': 'חשוב: חלון התיקון נסגר לחלק מהמשתתפים',
    'dashboard.tpR16IncidentClosed.adminSub': 'אנחנו מתנצלים מאוד. חלק מהמשתתפים בפול שלך מילאו את הנוקאאוט לפני שתיקנו את הבראקט לפי חוקי FIFA, וכעת שלב הנוקאאוט כבר נעול לעריכה.',
    'dashboard.tpR16IncidentClosed.adminPointsRisk': 'במסך המשתתפים עדיין אפשר לראות מי נפגע. מי שלא מילא מחדש לפני הנעילה עלול לפספס נקודות על בחירות שלא תואמות לבראקט המתוקן.',
    'dashboard.tpR16IncidentClosed.copyMessage': 'היי, FriendlyBet מתנצלת מאוד: הייתה תקלה בשיבוץ שלב הנוקאאוט בחלק מהבראקטים שמולאו היום. התקלה תוקנה לפי חוקי FIFA, אבל חלון המילוי מחדש כבר נסגר. משתתפים שלא מילאו מחדש עלולים לפספס נקודות על בחירות שלא תואמות לבראקט המתוקן. אפשר להיכנס ל-FriendlyBet כאן: {link}.',
    ...
    'tpRecovery.admin.grant': 'פתח נוקאאוט מחדש',
    'tpRecovery.admin.revoke': 'סגור גישה',
    'tpRecovery.admin.copy': 'העתק הודעה',
    'tpRecovery.admin.notOpened': 'אפשר לפתוח לו/לה מילוי מחדש לנוקאאוט',
    'tpRecovery.admin.openUntil': 'גישה פתוחה עד {time}',
    'tpRecovery.admin.used': 'המשתתף/ת כבר שמר/ה תיקון',
    'tpRecovery.admin.revokedStatus': 'גישת התיקון נסגרה',
    'tpRecovery.admin.granted': 'גישת נוקאאוט נפתחה מחדש',
    'tpRecovery.admin.revoked': 'גישת התיקון נסגרה',
    'tpRecovery.admin.notAvailable': 'לא ניתן לפתוח נוקאאוט מחדש למשתתף הזה כרגע.',
    'tpRecovery.admin.personalMsg': 'היי {name}! פתחתי לך ב-FriendlyBet גישה אישית למלא מחדש את שלב הנוקאאוט. משחקים שכבר התחילו או תלויים במשחק שהתחיל יישארו נעולים, ולכן כדאי להיכנס ל-friendlybet.live בהקדם.',
    'tpRecovery.user.title': 'הנוקאאוט נפתח לך מחדש',
    'tpRecovery.user.sub': 'האדמין פתח לך גישה לבדוק ולמלא מחדש את שלב הנוקאאוט. משחקים שכבר התחילו או תלויים בהם יישארו נעולים.',
    'tpRecovery.user.cta': 'מלא נוקאאוט מחדש',
    'tpRecovery.user.expires': 'פתוח עד {time}',
    'tpRecovery.user.walkthroughNote': 'מצב תיקון: אפשר לשנות רק משחקים שעדיין לא התחילו ושלא תלויים במשחק שכבר התחיל.',
    'tpRecovery.user.lockedMatch': 'המשחק הזה כבר נעול לתיקון.',
    'tpRecovery.user.lockedToast': 'המשחק הזה נעול ואי אפשר לשנות אותו עכשיו.',
    'tpRecovery.user.lockedChanged': 'חלק מהבחירות שניסית לשנות כבר נעולות. הבחירות שלא נעולות נשמרו רק אם הן תקינות.',
    'tpRecovery.user.saved': 'הנוקאאוט נשמר.',
    'tpRecovery.user.notAvailable': 'גישת הנוקאאוט מחדש לא זמינה כרגע.',
    ...
    'dashboard.liveStatus.lateKicker': 'הימור מאוחר',
    'dashboard.liveStatus.lateDeadline': 'נסגר ב-{time}',
    'dashboard.liveStatus.lateTitle': 'המונדיאל כבר התחיל - ההימורים עדיין פתוחים כאן',
    'dashboard.liveStatus.lateText': 'זה הימור שנפתח באיחור. אפשר להזמין חברים ולמלא הימורים עד {time}. אחרי זה ההרשמה והעריכה ייסגרו לכולם.',
    'dashboard.liveStatus.lateKnockoutKicker': 'הימור נוקאאוט',
    'dashboard.liveStatus.lateKnockoutDeadline': 'ננעל ב-{time}',
    'dashboard.liveStatus.lateKnockoutTitle': 'שלב הנוקאאוט פעיל',
    'dashboard.liveStatus.lateKnockoutText': 'אין כאן ניקוד על הבתים או מלך השערים. הבראקטים נעולים עכשיו, וכל משחק נוקאאוט יכול להזיז את הטבלה.',
    'dashboard.liveStatus.progress': '{done}/{total} משחקי בתים הסתיימו',
    'dashboard.liveStatus.groups': '{done}/{total} בתים הושלמו',
    'dashboard.officialStatus.kicker': 'ניקוד רשמי',
    'dashboard.officialStatus.pointsLive': 'נקודות נכנסו',
    'dashboard.officialStatus.firstGroupTitle': 'הניקוד הרשמי התחיל',
    'dashboard.officialStatus.firstGroupText': 'בית אחד כבר הושלם, והנקודות נכנסו לפי חוקי ההימור. שאר הניקוד יתעדכן כשעוד בתים יסיימו את כל 6 המשחקים.',
    'dashboard.officialStatus.severalGroupsTitle': 'הטבלה כבר זזה באמת',
    'dashboard.officialStatus.severalGroupsText': '{done}/{total} בתים כבר הושלמו. הניקוד ממשיך להתעדכן אוטומטית בכל פעם שבית נוסף נסגר.',
    'dashboard.officialStatus.thirdPlacePending': 'נקודות על שלישיות שעולות יחושבו רק אחרי שכל 12 הבתים יסתיימו, כי רק אז יודעים מי 8 השלישיות הטובות ביותר.',
    'dashboard.dataPending.kicker': 'בדיקה רשמית',
    'dashboard.dataPending.badge': 'מעדכנים עכשיו',
    'dashboard.dataPending.title': 'מעדכנים נתונים רשמיים',
    'dashboard.dataPending.text': 'אנחנו מאמתים את מצב המשחק ומחשבים את הניקוד החדש. בינתיים הנקודות שמופיעות הן הדירוג הרשמי האחרון.',
    'dashboard.dataPending.note': 'אם יש שינוי בניקוד, הטבלה תתעדכן אוטומטית ברגע שהחישוב יהיה בטוח להצגה.',
    'dashboard.liveUpdating.kicker': 'חי',
    'dashboard.liveUpdating.badge': 'חי',
    'dashboard.liveUpdating.title': 'המשחק חי',
    'dashboard.liveUpdating.text': 'המשחק חי. במסך המשחקים אפשר לראות עדכוני תוצאה ודקה כשהפיד החי זמין; הניקוד הרשמי נשאר על הדירוג האחרון עד שתהיה תוצאה סופית.',
    'dashboard.liveUpdating.note': 'אם התוצאה תשנה את הניקוד, הטבלה תתעדכן אוטומטית אחרי סיום המשחק.',
    'dashboard.resultConfirming.kicker': 'אישור תוצאה',
    'dashboard.resultConfirming.badge': 'מאמתים עכשיו',
    'dashboard.resultConfirming.title': 'מאשרים את תוצאת הסיום',
    'dashboard.resultConfirming.text': 'המשחק הסתיים ואנחנו מאמתים את התוצאה והמעפילה. הניקוד הרשמי יעודכן אחרי שהאימות יהיה בטוח להצגה.',
    'dashboard.resultConfirming.note': 'בינתיים מוצג הדירוג הרשמי האחרון.',
    'dashboard.groupStageComplete.kicker': 'הבתים הושלמו',
    'dashboard.groupStageComplete.badge': 'ניקוד בתים סופי',
    'dashboard.groupStageComplete.title': 'הטורניר עבר לנוקאאוט',
    'dashboard.groupStageComplete.text': 'ניקוד הבתים סופי, והמרדף עבר לשלב הנוקאאוט. הבראקטים נעולים, וכל תוצאה רשמית יכולה לשנות את הטבלה.',
    'dashboard.groupStageComplete.onePhaseText': 'ניקוד הבתים סופי, והבראקט שמילאת מראש כבר חי בשלב הנוקאאוט. כל תוצאה רשמית יכולה להזיז את הטבלה.',
    'tournamentContext.round.groups': 'שלב הבתים',
    'tournamentContext.round.generic': 'שלב הנוקאאוט',
    'tournamentContext.round.r32': 'שלב 32 האחרונות',
    'tournamentContext.round.r16': 'שמינית הגמר',
    'tournamentContext.round.qf': 'רבע הגמר',
    'tournamentContext.round.sf': 'חצי הגמר',
    'tournamentContext.round.thirdPlace': 'משחק המקום השלישי',
    'tournamentContext.round.final': 'גמר',
    'dashboard.tournament.genericKicker': 'הטורניר חי',
    'dashboard.tournament.genericBadge': 'ניקוד בתים סופי',
    'dashboard.tournament.genericTitle': 'הטורניר עבר לנוקאאוט',
    'dashboard.tournament.genericText': 'ניקוד הבתים סופי. אנחנו מציגים סטטוס זהיר עד שהשלב הנוכחי מאומת, והדירוג ימשיך לזוז עם תוצאות רשמיות.',
    'dashboard.tournament.roundKicker': '{round}',
    'dashboard.tournament.roundBadge': 'ניקוד בתים סופי',
    'dashboard.tournament.roundTitle': 'הטורניר עכשיו ב{round}',
    'dashboard.tournament.roundText': 'ניקוד הבתים סופי, והמרדף עבר ל{round}. הבראקטים נעולים, וכל תוצאה רשמית יכולה לשנות את הטבלה.',
    'dashboard.tournament.roundOnePhaseText': 'ניקוד הבתים סופי, והבראקט שמילאת מראש עכשיו ב{round}. כל תוצאה רשמית יכולה להזיז את הטבלה.',
    'dashboard.tournament.upcomingKicker': 'השלב הבא',
    'dashboard.tournament.upcomingTitle': 'השלב הבא: {round}',
    'dashboard.tournament.upcomingText': 'ניקוד הבתים סופי. אנחנו בין משחקים עכשיו; הדירוג יזוז שוב כשתוצאות {round} יהיו רשמיות.',
    'dashboard.tournament.confirmingBadge': 'מאמתים עכשיו',
    'dashboard.tournament.confirmingTitle': 'מאמתים את {round}',
    'dashboard.tournament.confirmingText': 'תוצאה אחרונה עוברת בדיקה לפני שינוי חדש בדירוג. בינתיים מוצג הדירוג הרשמי האחרון.',
    'dashboard.tournament.completeKicker': 'הטורניר הושלם',
    'dashboard.tournament.completeBadge': 'דירוג סופי',
    'dashboard.tournament.completeTitle': 'יש דירוג סופי',
    'dashboard.tournament.completeText': 'הגמר מאומת והדירוג הסופי מוצג. זה הרגע לפתוח את הצ׳אט ולחלק קבלות.',
    'pundit.title': 'הפרשן',
    ...
    'pundit.seeMore': 'עוד',
    'pundit.seeLess': 'פחות',
    'pundit.tournament.round': 'ניקוד הבתים רשמי, והשלב הנוכחי הוא {round}. כל פגיעה בבראקט יכולה להזיז את הטבלה.',
    'pundit.tournament.upcoming': '{round} הוא השלב הבא. עד שהתוצאות שלו יהיו רשמיות, הדירוג האחרון נשאר נקי וברור.',
    'pundit.tournament.confirming': 'תוצאה ב{round} עוברת אימות. הדירוג לא יקפוץ עד שהמעפילה בטוחה להצגה.',
    'pundit.tournament.generic': 'ניקוד הבתים רשמי. אנחנו שומרים על סטטוס נוקאאוט זהיר עד שהשלב הנוכחי מאומת.',
    'pundit.tournament.complete': 'הגמר מאומת והדירוג הסופי מוכן. עכשיו נשאר רק לחלק קבלות בצ׳אט.',
    'pundit.tournament.noStaleExact': 'אם פיד חי מתעכב, FriendlyBet נשארת על {round} ועל תוצאות רשמיות בלבד.',
    'pundit.tournament.noStaleGeneric': 'אם פיד חי מתעכב, FriendlyBet מציגה סטטוס זהיר ולא ממחזרת עדכונים ישנים.',
    'pundit.pool.tournamentRound': 'ניקוד הבתים רשמי, ו{round} היא עכשיו מרכז ההימור. כל פגיעה בבראקט יכולה להזיז את הפול.',
    'pundit.pool.tournamentRoundLocked': 'ניקוד הבתים רשמי, והבראקטים נעולים ב{round}. מכאן כל תוצאה רשמית יכולה להפוך את הטבלה.',
    'pundit.pool.tournamentGeneric': 'ניקוד הבתים רשמי והנוקאאוט פעיל. נציג שלב מדויק רק כשהמידע בטוח.',
    'pundit.pool.lockedTournamentRound': 'ההימור נעול, והפול עכשיו חי ב{round}. מי שמאחור צריך פגיעות בבראקט, לא עוד זמן לעריכות.',
    'pundit.pool.lockedTournamentGeneric': 'ההימור נעול והנוקאאוט פעיל. מי שמאחור צריך נקודות בראקט, והסטטוס יישאר זהיר עד אימות השלב.',
    'worldCupStories.kicker': 'הסטורי של המונדיאל',
    'worldCupStories.sub': 'רגעים מהמשחקים שכיף לשתף',
    'worldCupStories.share': 'שתף תמונה',
    'worldCupStories.previous': 'הסטורי הקודם',
    'worldCupStories.next': 'הסטורי הבא',
    'worldCupStories.caption': 'הסטורי של המונדיאל ב-FriendlyBet ⚽',
    'worldCupStories.downloaded': 'התמונה ירדה — אפשר להעלות אותה לסטורי',
    ...
    'dashboard.final.kicker': 'שריקת סיום',
    'dashboard.final.title': '{team} אלופת העולם',
    'dashboard.final.scoreline': '{home} {homeScore} - {awayScore} {away}',
    'dashboard.final.penalties': '{team} ניצחה בפנדלים',
    'dashboard.final.poolWinnersLabel': 'מנצחי הפול',
    'dashboard.final.goldenBootLabel': 'מלך השערים',
    'dashboard.final.winnerListExtra': ' ועוד {n}',
    'dashboard.final.share': 'שתף תמונת סיום',
    'dashboard.final.previewLoading': 'תמונת הסיום',
    'dashboard.final.previewAlt': 'תמונת הסיום של {pool}',
    'dashboard.final.shareCaption': 'תמונת הסיום של {pool} ב-FriendlyBet:',
    'dashboard.final.shareDownloaded': 'תמונת הסיום ירדה והטקסט הועתק',
    'dashboard.final.shareUnavailable': 'תמונת הסיום עדיין לא מוכנה',
    'dashboard.final.unknownTopScorer': 'טרם אומת',
    'dashboard.final.cardKicker': 'FriendlyBet Final',
    'dashboard.final.cardTitle': '{team} אלופת העולם',
    'dashboard.final.cardWinners': 'מנצחי הפול',
    'dashboard.final.cardGoldenBoot': 'מלך השערים',
    'dashboard.final.cardTagline': 'חינם, בלי הרשמה ובלי כסף אמיתי',
    ...
    'dashboard.status.verifyingBracket': 'שלב הבתים הסתיים. אנחנו מאמתים את העולות לפני פתיחת הנוקאאוט.',
    'dashboard.status.fairPlayDelay': 'יש שוויון שמוכרע לפי כללי המשמעת. הנוקאאוט ייפתח רק אחרי אימות.',
    'dashboard.status.koReady': 'שלב הנוקאאוט פעיל · 31 משחקים',
    'dashboard.status.partialKo': 'הימרת על {n} מתוך 31 · שלב הנוקאאוט פעיל',
    'dashboard.status.completedKo': 'הושלם · הבראקט נעול',
    'dashboard.twoPhase.waitingKnockout': 'בחירות הבתים נשמרו. הנוקאאוט ייפתח כשהבראקט הרשמי יהיה סופי לפי FIFA.',
    'dashboard.twoPhase.knockoutOpenTitle': 'שלב הנוקאאוט פעיל',
    'dashboard.twoPhase.knockoutOpenSub': 'הבראקטים נעולים עכשיו. מכאן כל משחק נוקאאוט יכול להזיז את הטבלה.',
    'dashboard.twoPhase.closedTitle': 'התחזיות נעולות',
    'dashboard.twoPhase.closedSub': 'חלון הנוקאאוט ומלך השערים נסגר ב-{time}. אפשר לצפות במה שנשמר; אם יש גישת תיקון מהאדמין, היא תופיע כאן.',
    'dashboard.twoPhase.closedToast': 'החלון לשמירת הנוקאאוט ומלך השערים כבר נסגר.',
    ...
    'dashboard.invite.lateKnockoutTitle': 'הזמינו חברים להימור נוקאאוט',
    'dashboard.invite.lateKnockoutSubtitle': 'הבתים נעולים. הימורי הנוקאאוט יינעלו ב-{knockoutTime}',
    'dashboard.quickAction.leaderboard': 'דירוג',
    'dashboard.quickAction.help': 'עזרה',
    'dashboard.impact.rank': 'מקום',
    'dashboard.impact.points': 'נקודות',
    'dashboard.impact.gap': 'פער מהמוביל',
    'dashboard.impact.openLeaderboard': 'פתח דירוג',
    'dashboard.impact.viewBracket': 'ראה בראקט',
    'dashboard.impact.liveKicker': 'חי עכשיו',
    'dashboard.impact.liveTitle': 'המשחק החי והניקוד שלך',
    'dashboard.impact.confirmingKicker': 'בודקים תוצאה',
    'dashboard.impact.confirmingTitle': 'הדירוג נשאר על המאומת האחרון',
    'dashboard.impact.idleKicker': 'ניקוד ומשחקים',
    'dashboard.impact.idleTitle': 'תוצאה אחרונה והמשחק הבא',
    'dashboard.impact.idleSub': 'נעדכן כשיהיה משחק נוסף על הלוח',
    'dashboard.impact.statusLive': 'LIVE',
    'dashboard.impact.statusChecking': 'בודקים',
    'dashboard.impact.statusNext': 'NEXT',
    'dashboard.impact.statusFinal': 'סופי',
    'dashboard.impact.lastResult': 'תוצאה אחרונה',
    'dashboard.impact.nextMatch': 'המשחק הבא',
    'dashboard.impact.ifAdvances': 'אם היא עולה',
    'dashboard.impact.ifTeamAdvances': 'אם {team} עולה',
    'dashboard.impact.teamAdvanced': '{team} עלתה',
    'dashboard.impact.teamEliminated': '{team} הודחה',
    'dashboard.impact.resultPoints': 'קיבלת על {team} שעלתה',
    'dashboard.impact.resultPending': 'העולה עדיין לא אומתה',
    'dashboard.impact.pointsDelta': '+{points}',
    'dashboard.impact.pointsChecking': 'לא זמין',
    'dashboard.impact.pointsUnavailable': 'לא זמין',
    'dashboard.impact.pointsValueOne': '{points} נקודה',
    'dashboard.impact.pointsValueOther': '{points} נקודות',
    'dashboard.impact.scenarioPointsSentence': 'אם {team} תעלה, תקבל {points} בפול שלך.',
    'dashboard.impact.resultPointsSentence': 'קיבלת {points} בפול שלך על העלייה של {team}.',
    'dashboard.impact.scenarioPointsUnavailable': 'אם {team} תעלה, הניקוד מהפול שלך יופיע אחרי טעינת הבחירות.',
    'dashboard.impact.resultPointsUnavailable': 'הניקוד שלך על העלייה של {team} יופיע אחרי טעינת הבחירות.',
    'dashboard.impact.finalScenarioPointsSentence': 'אם {team} תזכה, תקבל {points} בפול שלך.',
    'dashboard.impact.finalResultPointsSentence': 'קיבלת {points} בפול שלך על הזכייה של {team}.',
    'dashboard.impact.finalScenarioPointsUnavailable': 'אם {team} תזכה, הניקוד מהפול שלך יופיע אחרי טעינת הבחירות.',
    'dashboard.impact.finalResultPointsUnavailable': 'הניקוד שלך על הזכייה של {team} יופיע אחרי טעינת הבחירות.',
    'dashboard.impact.noResultYet': 'עדיין אין תוצאה מאומתת להצגה.',
    'dashboard.impact.noNextMatch': 'אין משחק הבא להצגה כרגע.',
    'dashboard.projection.kicker': 'טבלה תיאורטית בלבד',
    'dashboard.projection.title': 'אם הבתים היו נגמרים עכשיו...',
    'dashboard.projection.sub': 'קפוץ לראות איך הטבלה הייתה נראית כרגע.',
    'dashboard.projection.subWithScore': 'כרגע היית מקום {rank} עם {points} נק׳ תיאורטיות.',
    'dashboard.projection.rank': 'תיאורטי',
    'dashboard.projection.cta': 'לראות את הדרמה',
    'dashboard.projection.punditMe': 'הפרשן: נחמד, אבל שער אחד וכל הסיפור מתהפך.',
    'dashboard.projection.punditLeader': 'הפרשן: כרגע {name} בראש עם {points}. לא רשמי, כן מלחיץ.',
    'dashboard.projection.punditZero': 'הפרשן: עוד אין נקודות תיאורטיות, אבל הלוח כבר מתחמם.',
    'dashboard.drama.fallbackLeader': 'המוביל',
    'dashboard.drama.pill.pool': 'דרמת קבוצה',
    'dashboard.drama.pill.yourMove': 'התור שלך',
    'dashboard.drama.pill.action': 'לטפל עכשיו',
    'dashboard.drama.pill.live': 'חי',
    'dashboard.drama.pill.checking': 'בודקים נקודות',
    'dashboard.drama.pill.official': 'דירוג רשמי',
    'dashboard.drama.pill.knockout': 'נוקאאוט',
    'dashboard.drama.meta.pool': '{n} חברים בפול',
    'dashboard.drama.meta.leading': '{points} נק׳ ואתה על הגג',
    'dashboard.drama.meta.chasing': '{points} נק׳ · {gap} מהמקום הראשון',
    'dashboard.drama.pre.title': 'הפול מתחמם לפני השריקה',
    'dashboard.drama.pre.text': '{n} חברים כבר בפנים. עכשיו רק צריך למלא הימורים, לשלוח לקבוצה, ולחכות לעקיצות.',
    'dashboard.drama.picks.title': 'עוד לא נכנסת לדרמה',
    'dashboard.drama.picks.text': 'מלא את ההימור שלך לפני שהקבוצה מתחילה לרוץ קדימה. אחר כך כבר נשאר רק לרדוף.',
    'dashboard.drama.lateKnockout.title': 'הנוקאאוט פתוח, אין זמן להתחמם',
    'dashboard.drama.lateKnockout.text': 'מלא את הבראקט עד {time}. מכאן כל משחק יכול להעיף את הטבלה לצד אחר.',
    'dashboard.drama.recovery.title': 'קודם מצילים את ההימור',
    'dashboard.drama.recovery.text': 'יש פעולה שצריך להשלים כדי שההימור שלך יהיה בטוח. הדרמה תחכה רגע.',
    'dashboard.drama.admin.title': 'יש לך הודעה לשלוח לקבוצה',
    'dashboard.drama.admin.text': 'חלק מהחברים צריכים להיכנס שוב או להשלים בחירות. זה הזמן להעיר את הצ׳אט.',
    'dashboard.drama.live.title': 'המשחקים רצים, הטבלה עוד מחכה',
    'dashboard.drama.live.text': '{done}/{total} משחקי בתים כבר הסתיימו או זזים. הניקוד הרשמי יגיע כשבית שלם נסגר.',
    'dashboard.drama.checking.title': 'הדירוג האחרון מוצג, הנקודות החדשות בבדיקה',
    'dashboard.drama.checking.text': 'יש תוצאה שיכולה להזיז את הטבלה. עד שהאימות ייסגר, מציגים את הדירוג הרשמי האחרון.',
    'dashboard.drama.officialLeader.title': 'אתה מוביל. עכשיו כולם רודפים אחריך.',
    'dashboard.drama.officialLeader.text': 'אתה במקום הראשון עם {points} נק׳. כל מחזור הבא הוא הזדמנות של הקבוצה להפיל אותך.',
    'dashboard.drama.officialChaser.title': 'אתה #{rank}. עדיין לגמרי בתמונה.',
    'dashboard.drama.officialChaser.text': '{gap} נק׳ מהמוביל {leader}. פגיעה אחת טובה והצ׳אט יכול להתהפך.',
    'dashboard.drama.knockout.title': 'הנוקאאוט התחיל. כל משחק יכול להפוך את הצ׳אט.',
    'dashboard.drama.knockout.text': 'אתה #{rank} עם {points} נק׳. מכאן כל מעפילה יכולה לשנות את הסיפור.',
    'dashboard.drama.knockoutNoRank.title': 'הנוקאאוט פותח מחדש את הדרמה',
    'dashboard.drama.knockoutNoRank.text': 'הבתים מאחורינו. עכשיו כל משחק נוקאאוט יכול להזיז את הטבלה.',
    'dashboard.drama.tournamentRound.title': 'הטורניר עכשיו ב{round}',
    'dashboard.drama.tournamentRound.text': 'הדירוג הרשמי חי. כל מעפילה ב{round} יכולה להפוך את הצ׳אט.',
    'dashboard.drama.tournamentUpcoming.title': 'השלב הבא כבר על הלוח',
    'dashboard.drama.tournamentUpcoming.text': '{round} מחכה לתוצאות הרשמיות הבאות. עד אז הדירוג האחרון נשאר יציב.',
    'dashboard.drama.tournamentConfirming.title': 'בודקים תוצאה ב{round}',
    'dashboard.drama.tournamentConfirming.text': 'מציגים את הדירוג הרשמי האחרון עד שהאימות נסגר בבטחה.',
    'dashboard.drama.tournamentGeneric.title': 'הטורניר חי, הסטטוס נשאר זהיר',
    'dashboard.drama.tournamentGeneric.text': 'ניקוד הבתים סופי. נציג שלב מדויק רק כשהמידע בטוח, בלי למכור עדכון ישן כאילו הוא חי.',
    'dashboard.drama.tournamentComplete.title': 'הפול הגיע לקו הסיום',
    'dashboard.drama.tournamentComplete.text': 'הגמר מאומת והדירוג הסופי מוכן. עכשיו נשאר רק להתווכח מי ידע מראש.',
    'dashboard.drama.action.pick': 'להיכנס להימור',
    'dashboard.drama.action.fix': 'לטפל בהימור',
    'dashboard.drama.action.members': 'לראות חברים',
    'dashboard.drama.action.leaderboard': 'לפתוח דירוג',
    'dashboard.drama.action.projection': 'לראות דרמה',
    'dashboard.drama.metric.members': 'חברים',
    'dashboard.drama.metric.lock': 'נעילה',
    'dashboard.drama.metric.action': 'פעולה',
    'dashboard.drama.metric.lastRank': 'דירוג אחרון',
    'dashboard.drama.metric.rank': 'מקום',
    'dashboard.drama.metric.points': 'נקודות',
    'dashboard.drama.metric.status': 'סטטוס',
    'dashboard.drama.metric.leaderValue': 'מוביל',
    'dashboard.drama.metric.behind': 'מהמוביל',
    'dashboard.drama.metric.groups': 'בתים',
    'dashboard.drama.metric.matches': 'משחקים',
    ...
    'dashboard.menu.primary': 'ראשי',
    'dashboard.menu.myPrediction': 'ההימור שלי',
    'dashboard.menu.pool': 'ההימור',
    'dashboard.menu.account': 'החשבון שלי',
    'dashboard.menu.support': 'תמיכה',
    'dashboard.menu.exitSection': 'יציאה',
    ...
    'leaderboard.participantsList': 'משתתפים בפול',
    ...
    'leaderboard.statusLiveNoOfficial': 'חי - הנקודות ייכנסו כשבית שלם יסתיים',
    'leaderboard.statusOfficialStarted': 'ניקוד רשמי פעיל - {groups}/{total} בתים הושלמו',
    'leaderboard.statusGroupsComplete': 'שלב הנוקאאוט פעיל - הלידרבורד זז עם תוצאות רשמיות',
    'leaderboard.statusTournamentRound': '{round} בעיצומה - הלידרבורד זז עם כל תוצאה רשמית',
    'leaderboard.statusTournamentUpcoming': 'השלב הבא: {round} - הדירוג יזוז עם התוצאה הרשמית הבאה',
    'leaderboard.statusTournamentConfirming': 'מאמתים תוצאה ב{round} - מוצג הדירוג הרשמי האחרון',
    'leaderboard.statusTournamentGeneric': 'שלב הנוקאאוט פעיל - מציגים סטטוס זהיר עד שהשלב מאומת',
    'leaderboard.statusTournamentComplete': 'הטורניר הושלם - הדירוג הסופי מוצג',
    'leaderboard.statusDataPending': 'מעדכנים נתונים רשמיים - מוצג הדירוג הרשמי האחרון',
    'leaderboard.emptyLiveNoOfficialTitle': 'המשחקים כבר התחילו',
    'leaderboard.emptyLiveNoOfficialText': 'עדיין אין נקודות רשמיות בהימור הזה. נקודות על בתים נכנסות רק כשבית שלם מסיים את כל 6 המשחקים.',
    'leaderboard.emptyOfficialZeroTitle': 'הניקוד הרשמי כבר פעיל',
    'leaderboard.emptyOfficialZeroText': 'הושלמו {groups} מתוך {total} בתים. אם עדיין אין כאן נקודות, זה רק אומר שאף אחד לא פגע בניקוד הבתים; המרדף הבא הוא דרך הנוקאאוט.',
    'leaderboard.emptyDataPendingTitle': 'הטבלה מתעדכנת',
    'leaderboard.emptyDataPendingText': 'יש משחק שנמצא בבדיקה רשמית. עדיין אין נקודות רשמיות בפול הזה, והטבלה תתעדכן ברגע שהחישוב יסתיים.',
    'leaderboard.calculatingShort': '...',
    'leaderboard.calculatingLabel': 'בבדיקה',
    'leaderboard.lastOfficialLabel': 'רשמי אחרון',
    'leaderboard.calculatingBreakdown': 'הנתונים הרשמיים מתעדכנים',
    'leaderboard.thirdPlacePending': 'נקודות על שלישיות שעולות יחושבו רק אחרי שכל 12 הבתים יסתיימו, כי רק אז יודעים מי 8 השלישיות הטובות ביותר.',
    'leaderboard.podiumEmpty': 'ריק',
    'leaderboard.noPointsYet': 'עדיין בלי נקודות',
    'leaderboard.banter.tournamentLeader': '{name} מוביל עם {points} נק׳ כש{round} בעיצומה. עכשיו כל תוצאה רשמית יכולה לשנות את המרדף.',
    'leaderboard.banter.tournamentGenericLeader': '{name} מוביל עם {points} נק׳ בזמן שהנוקאאוט פעיל. נישאר זהירים עד שהשלב הנוכחי מאומת.',
    'leaderboard.banter.tournamentHeadline': 'ניקוד הבתים רשמי, ו{round} היא עכשיו הסיפור. מכאן הלידרבורד זז דרך הבראקט, האלופה ומלך השערים.',
    'leaderboard.banter.tournamentGeneric': 'ניקוד הבתים רשמי והנוקאאוט פעיל. מציגים סטטוס זהיר עד שהשלב הנוכחי מאומת.',
    'leaderboard.banter.tournamentChase': 'אין יותר טבלת בתים תיאורטית. מי שמאחור צריך פגיעות ב{round}, לא עוד תירוצים.',
    'leaderboard.banter.tournamentGenericChase': 'אין יותר טבלת בתים תיאורטית. מי שמאחור צריך נקודות נוקאאוט, והאפליקציה לא תציג עדכון ישן כאילו הוא חי.',
    ...
    'leaderboard.projection.kicker': 'טבלה תיאורטית בלבד',
    'leaderboard.projection.title': 'הפודיום התיאורטי',
    'leaderboard.projection.pill': 'לא רשמי',
    'leaderboard.projection.note': 'שום נקודה תיאורטית לא נספרת. זה רק “מה היה קורה אם הבתים היו נגמרים עכשיו”.',
    'leaderboard.projection.source': 'מבוסס על {groups} מתוך {total} בתים שכבר התחילו, עם תוצאות סופיות או לייב אמין.',
    'leaderboard.projection.points': 'תיאורטי',
    'leaderboard.projection.groupHits': '{n} פגיעות בתים כרגע',
    'leaderboard.projection.officialStillZero': 'לא ניקוד רשמי',
    'leaderboard.projection.punditMe': 'הפרשן: כרגע היית במקום {rank} עם {points}. תצלם מהר לפני שבית ג׳ הורס לך את החגיגה.',
    'leaderboard.projection.punditLeader': 'הפרשן: {name} על כס המלכות התיאורטי עם {points}. שער אחד, והכתר נופל.',
    'leaderboard.projection.punditZero': 'הפרשן: עדיין אין נקודות תיאורטיות, אבל שער אחד יכול לפתוח פה דרמה.',
    'leaderboard.projection.shareButton': 'שתף תמונת פודיום',
    'leaderboard.projection.shareCaption': 'הפודיום התיאורטי של {pool} ב-FriendlyBet. לא ניקוד רשמי — רק דרמה חיה.',
    'leaderboard.projection.shareDownloaded': 'תמונת הפודיום ירדה והטקסט הועתק',
    'leaderboard.projection.shareUnavailable': 'הפודיום התיאורטי עדיין לא מוכן לשיתוף',
    'leaderboard.projection.placeFirst': 'מקום 1',
    'leaderboard.projection.placeSecond': 'מקום 2',
    'leaderboard.projection.placeThird': 'מקום 3',
    'leaderboard.projection.cardKicker': 'טבלה תיאורטית בלבד',
    'leaderboard.projection.cardTitle': 'אם הבתים היו נגמרים עכשיו',
    'leaderboard.projection.cardNote': 'פודיום זמני לפי {groups} בתים פעילים',
    'leaderboard.projection.cardDisclaimer': 'לא ניקוד רשמי',
    'leaderboard.projection.cardTagline': 'שער אחד יכול להפוך את כל הטבלה',
    ...
    'poolFound.statusLateKnockoutOpen': 'הימור נוקאאוט פתוח עד {time}',
    ...
    'sharePool.shareTextLate': 'הוזמנת להצטרף להימור מאוחר "{poolName}" 🏆\n\nהמונדיאל כבר התחיל, אבל בהימור הזה עדיין אפשר להצטרף ולמלא הימורים עד {time}.\n\nקוד הצטרפות: {code}\n👉 {url}\n\n⚽ FriendlyBet — הימור חברים על מונדיאל 2026',
    'sharePool.shareTextLateKnockout': 'הוזמנת להצטרף להימור נוקאאוט "{poolName}" 🏆\n\nשלב הבתים כבר נעול, אבל אפשר להצטרף עכשיו ולהמר על כל הבראקט עד {knockoutTime}.\n\nקוד הצטרפות: {code}\n👉 {url}\n\n⚽ FriendlyBet — הימור חברים על מונדיאל 2026',
    'bracketShare.cta': 'שתף את הבראקט שלי',
    'bracketShare.imageCta': '\u05e9\u05ea\u05e4\u05d5 \u05d0\u05ea \u05ea\u05de\u05d5\u05e0\u05ea \u05d4\u05e0\u05d9\u05e6\u05d7\u05d5\u05df',
    'bracketShare.fullPredictionCta': '\u05e9\u05ea\u05e4\u05d5 \u05d0\u05ea \u05d4\u05d4\u05d9\u05de\u05d5\u05e8 \u05d4\u05de\u05dc\u05d0',
    'bracketShare.summaryHelper': '\u05e7\u05d5\u05d3\u05dd \u05db\u05dc \u05de\u05e9\u05ea\u05e4\u05d9\u05dd \u05d0\u05ea \u05ea\u05de\u05d5\u05e0\u05ea \u05d4\u05e0\u05d9\u05e6\u05d7\u05d5\u05df. \u05de\u05d9 \u05e9\u05e8\u05d5\u05e6\u05d4 \u05d9\u05db\u05d5\u05dc \u05dc\u05e9\u05ea\u05e3 \u05d2\u05dd \u05d0\u05ea \u05d4\u05d4\u05d9\u05de\u05d5\u05e8 \u05d4\u05de\u05dc\u05d0.',
    'bracketShare.imageTitle': 'My Road to Victory',
    'bracketShare.fullPredictionTitle': '\u05d4\u05d4\u05d9\u05de\u05d5\u05e8 \u05d4\u05de\u05dc\u05d0 \u05e9\u05dc\u05d9 \u05dc\u05de\u05d5\u05e0\u05d3\u05d9\u05d0\u05dc 2026',
    'bracketShare.imageOnlyDownloaded': '\u05d4\u05ea\u05de\u05d5\u05e0\u05d4 \u05d9\u05e8\u05d3\u05d4 \u05dc\u05de\u05db\u05e9\u05d9\u05e8',
    ...
    'groups.current.compare': 'השוואה למצב הבית כרגע',
    'groups.current.aria': 'טבלת מצב בית {letter}',
    'groups.current.actual': 'בפועל',
    'groups.current.pointsShort': 'נק׳',
    'groups.current.playedShort': 'מש׳',
    'groups.current.noFinalResults': 'אין עדיין תוצאות סופיות בבית הזה',
    ...
    'knockoutEx.notOpenExact': 'הנוקאאוט עדיין לא פתוח. נפתח אותו רק כשהבראקט הרשמי של FIFA יהיה סופי.',
    ...
    // === Matches extras ===
    'matchesEx.filterTimeline': 'ציר זמן',
    'matchesEx.filterNext': 'הבא',
    'matchesEx.filterResults': 'תוצאות',
    ...
    'matchesEx.liveResultAfterFinal': 'המשחק חי. הניקוד הרשמי יתעדכן אחרי הסיום.',
    'matchesEx.liveFeedConnectingNote': 'המשחק חי. מתחברים לעדכון החי של התוצאה והדקה.',
    'matchesEx.verifyingResult': 'מאשרים תוצאה רשמית',
    'matchesEx.resultBeingVerified': 'הנתונים הרשמיים מתעדכנים עכשיו',
    'matchesEx.statusBeingVerified': 'אנחנו בודקים את מצב המשחק. עד שהמידע יהיה בטוח לא נציג תוצאה ישנה או לא סופית.',
    'matchesEx.finalBeingConfirmed': 'מאשרים את תוצאת הסיום',
    'matchesEx.finalBeingConfirmedNote': 'אנחנו מאמתים את התוצאה הסופית והמעפילה. הניקוד יתעדכן רק אחרי שהאימות יסתיים.',
    'matchesEx.liveScoreUpdatingNote': 'המשחק חי. מתחברים לעדכון החי של התוצאה והדקה.',
    'matchesEx.liveStatusUpdatingNote': 'אנחנו בודקים את מצב המשחק האחרון. עד שהמידע יהיה אמין לא נציג תוצאה ישנה.',
    ...
    'matchesEx.officialUpdated': 'לוח רשמי: {time}',
    ...
    'matchesEx.yesterday': 'אתמול',
    'matchesEx.today': 'היום',
    'matchesEx.tomorrow': 'מחר',
    'matchesEx.currentAnchor': 'הרגע הנוכחי בטורניר',
    'matchesEx.matchNumberShort': 'משחק {n}',
    'matchesEx.nowChecking': 'מעדכנים נתונים רשמיים',
    'matchesEx.nowCheckingSub': 'בודקים את מצב המשחק ומחשבים נקודות לפני שמציגים תוצאה',
    'matchesEx.nowLive': '{n} משחקים חיים עכשיו',
    'matchesEx.nowNext': 'המשחק הבא',
    'matchesEx.nowComplete': 'אין משחקים פעילים כרגע',
    'matchesEx.nextMatchLabel': 'הבא',
    'matchesEx.latestResultLabel': 'תוצאה אחרונה',
    'matchesEx.checkingMatchLabel': 'בבדיקה',
    'matchesEx.statusLabel': 'סטטוס',
    'matchesEx.finalizingShort': 'מעדכנים',
    'matchesEx.tournamentProgressLabel': 'התקדמות',
    'matchesEx.tournamentProgressValue': '{finished}/{total}',
    'matchesEx.noneShort': 'אין',
    'matchesEx.jumpNow': 'עכשיו',
    'matchesEx.jumpToday': 'היום',
    'matchesEx.jumpNext': 'הבא',
    'matchesEx.jumpResults': 'תוצאות',
    ...
    'matchesEx.stageR32': 'שלב 32 האחרונות',
    ...
    'tsLocked.closedTitle': 'חלון מלך השערים נסגר',
    'tsLocked.closedSubtitle': 'אי אפשר לשמור בחירה חדשה אחרי {time}',
    'tsLocked.closedWhy': 'למה זה נעול?',
    'tsLocked.closedWhyText': 'חלון מלך השערים של ההימור הזה נסגר ב-{time}, אחרי תחילת הנוקאאוט.',
    'tsLocked.closedHow': 'אפשר לפתוח את זה?',
    'tsLocked.closedHowText': 'לא אוטומטית. תיקון אחרי הדדליין זמין רק לנוקאאוט ורק דרך האדמין כשיש גישת תיקון.',
    'tsLocked.closedWhat': 'מה אפשר לעשות עכשיו?',
    'tsLocked.closedWhatText': 'אפשר לחזור לדשבורד ולצפות במה שנשמר. אם האדמין פתח לך תיקון נוקאאוט, תראה שם כפתור ייעודי.',
    'tsLocked.closedStatus': 'החלון נסגר',
    ...
    'membersList.r16IncidentTitle': 'משתתפים שצריכים למלא מחדש',
    'membersList.r16IncidentText': 'נמצאו {n} משתתפים שמילאו את הנוקאאוט לפני תיקון הבראקט. הם מסומנים בראש הרשימה.',
    'membersList.r16IncidentFlag': 'צריך למלא מחדש את הנוקאאוט',
    'membersList.r16IncidentClosedTitle': 'משתתפים שנפגעו מהתיקון',
    'membersList.r16IncidentClosedText': 'נמצאו {n} משתתפים שמילאו את הנוקאאוט לפני תיקון הבראקט. חלון המילוי מחדש נסגר, והם עדיין מסומנים בראש הרשימה.',
    'membersList.r16IncidentClosedFlag': 'חלון המילוי נסגר',
    'membersList.r16IncidentLoadError': 'לא הצלחנו לטעון את סימון המשתתפים שנפגעו',
    ...
    'errors.poolClosedKnockout': '🔒 פול הנוקאאוט הזה נסגר עם פתיחת שלב הנוקאאוט ({knockoutTime}).',
    'errors.lateEntryClosed': '🔒 אי אפשר ליצור הימורים חדשים אחרי תחילת המשחק השני של קבוצה כלשהי ({time}).',
    'errors.lateKnockoutCreationClosed': '🔒 אי אפשר ליצור פול נוקאאוט חדש אחרי פתיחת שלב הנוקאאוט ({time}).',
    ...
    'wizard.multipliers.lateKnockoutNote': 'בפול נוקאאוט מאוחר המכפילים חלים רק על בחירות הנוקאאוט.',
    ...
    'betting.summary.warningLate': 'הפול הזה פתוח למצטרפים מאוחרים. ניתן לערוך את הבחירות עד {time}.',
    'betting.summary.warningLateKnockout': 'זה פול נוקאאוט מאוחר. שלב הבתים נעול, ואפשר לערוך את הבראקט עד {knockoutTime}.',
    'lateKnockout.waitingToast': 'שלב הבתים עדיין פתוח. הנוקאאוט ייפתח כשהבתים יסתיימו.',
    ...
    'betting.summary.editPrediction': 'ערוך את ההימור',
    ...
    'dashboard.continueCta.lateKnockout': 'השלמת {n} מתוך {total} בחירות נוקאאוט',
    ...
    'dashboard.viewCta.lateKnockoutSubtitle': 'אפשר לעדכן את הבראקט עד {time}',
    'dashboard.viewCta.reviewSubtitle': 'חלון הבדיקה פתוח — אפשר לבדוק ולעדכן את הנוקאאוט',
    'dashboard.lateKnockout.waitingTitle': 'הנוקאאוט ייפתח אחרי הבתים',
    'dashboard.lateKnockout.waitingSubtitle': 'שלב הבתים כבר נעול להימורים. הזמינו חברים עכשיו והבראקט ייפתח כשהבתים יסתיימו.',
    'dashboard.lateKnockout.startTitle': 'התחל להמר על הנוקאאוט',
    'dashboard.lateKnockout.startSubtitle': 'מלא את הבראקט לפני {time}',
    'wizard.lateKnockout.title': 'פול נוקאאוט',
    'wizard.lateKnockout.subtitle': 'שלב הבתים כבר נעול. בחרו ניקוד לבראקט הנוקאאוט.',
    'wizard.lateKnockout.notice': 'הפול ייפתח להימורי נוקאאוט כשהבתים יסתיימו. הבחירות יינעלו ב-{time}.',
    'wizard.lateKnockout.modeTitle': 'פול נוקאאוט',
  ...
  en: {
    ...
    'recoveryLogin.signingIn': 'Signing in...',
    ...
    'dashboard.tpR16Incident.title': 'Important: please refill your knockout bracket',
    'dashboard.tpR16Incident.sub': 'We are very sorry. Because of a mistake on our side, some knockout matches were wired incorrectly when you filled your bracket. We fixed the bracket according to FIFA rules. Please refill the knockout stage so your picks match the official bracket.',
    'dashboard.tpR16Incident.pointsRisk': 'If you do not refill it, some existing picks may no longer match the corrected games and you may miss out on points.',
    'dashboard.tpR16Incident.cta': 'Refill knockout',
    'dashboard.tpR16Incident.adminTitle': 'Important: some members filled an inaccurate bracket',
    'dashboard.tpR16Incident.adminSub': 'We are very sorry. Because of a mistake on our side, some members in your pool filled the knockout stage while the bracket wiring was incorrect. We fixed the bracket according to FIFA rules.',
    'dashboard.tpR16Incident.adminPointsRisk': 'Please make sure everyone who filled before the fix reopens the app and refills the knockout bracket while it is still editable, before the knockout stage starts. Members who do not refill may miss out on points.',
    'dashboard.tpR16Incident.adminCta': 'View members',
    'dashboard.tpR16Incident.copy': 'Copy message for the group',
    'dashboard.tpR16Incident.copyMessage': 'Hi, FriendlyBet is very sorry: there was a mistake in the knockout bracket wiring for some brackets filled today. It has been fixed according to FIFA rules. If you already filled the knockout stage before the fix, please reopen the app and refill the knockout stage: {link}. If you do not refill it, you may miss out on points.',
    'dashboard.tpR16IncidentClosed.title': 'Important: the knockout refill window has closed',
    'dashboard.tpR16IncidentClosed.sub': 'We are very sorry. Your bracket was filled before we corrected the knockout wiring according to FIFA rules, and the knockout stage is now locked for editing.',
    'dashboard.tpR16IncidentClosed.pointsRisk': 'Some old picks may no longer match the corrected games, so they may not receive points.',
    'dashboard.tpR16IncidentClosed.adminTitle': 'Important: the correction window has closed for some members',
    'dashboard.tpR16IncidentClosed.adminSub': 'We are very sorry. Some members in your pool filled the knockout stage before we corrected the bracket according to FIFA rules, and the knockout stage is now locked for editing.',
    'dashboard.tpR16IncidentClosed.adminPointsRisk': 'You can still see who was affected in the members screen. Members who did not refill before lock may miss points for picks that do not match the corrected bracket.',
    'dashboard.tpR16IncidentClosed.copyMessage': 'Hi, FriendlyBet is very sorry: there was a mistake in the knockout bracket wiring for some brackets filled today. It has been fixed according to FIFA rules, but the refill window is now closed. Members who did not refill may miss points for picks that do not match the corrected bracket. You can open FriendlyBet here: {link}.',
    ...
    'tpRecovery.admin.grant': 'Reopen knockout',
    'tpRecovery.admin.revoke': 'Close access',
    'tpRecovery.admin.copy': 'Copy message',
    'tpRecovery.admin.notOpened': 'You can reopen knockout picks for this member',
    'tpRecovery.admin.openUntil': 'Recovery access open until {time}',
    'tpRecovery.admin.used': 'This member has already saved a recovery update',
    'tpRecovery.admin.revokedStatus': 'Recovery access was closed',
    'tpRecovery.admin.granted': 'Knockout access reopened',
    'tpRecovery.admin.revoked': 'Recovery access closed',
    'tpRecovery.admin.notAvailable': 'Knockout re-entry is not available for this member right now.',
    'tpRecovery.admin.personalMsg': 'Hi {name}! I opened personal access for you in FriendlyBet to refill the knockout stage. Matches that already started, and matches depending on a started match, stay locked, so please open friendlybet.live as soon as you can.',
    'tpRecovery.user.title': 'Your knockout picks are reopened',
    'tpRecovery.user.sub': 'Your admin opened access for you to review and refill the knockout stage. Matches that already started, and matches depending on them, stay locked.',
    'tpRecovery.user.cta': 'Refill knockout',
    'tpRecovery.user.expires': 'Open until {time}',
    'tpRecovery.user.walkthroughNote': 'Recovery mode: you can edit only matches that have not started and do not depend on a match that already started.',
    'tpRecovery.user.lockedMatch': 'This match is already locked for recovery.',
    'tpRecovery.user.lockedToast': 'This match is locked and cannot be changed now.',
    'tpRecovery.user.lockedChanged': 'Some picks you tried to change are already locked. Only valid unlocked changes can be saved.',
    'tpRecovery.user.saved': 'Knockout picks saved.',
    'tpRecovery.user.notAvailable': 'Knockout re-entry is not available right now.',
    ...
    'dashboard.liveStatus.lateKnockoutKicker': 'KNOCKOUT POOL',
    'dashboard.liveStatus.lateKnockoutDeadline': 'Locks {time}',
    'dashboard.liveStatus.lateKnockoutTitle': 'Knockout stage active',
    'dashboard.liveStatus.lateKnockoutText': 'There are no group-stage or top-scorer points here. Brackets are locked now, and every knockout match can move the table.',
    'dashboard.liveStatus.progress': '{done}/{total} group matches finished',
    'dashboard.liveStatus.groups': '{done}/{total} groups finalized',
    'dashboard.officialStatus.kicker': 'OFFICIAL SCORING',
    'dashboard.officialStatus.pointsLive': 'Points are live',
    'dashboard.officialStatus.firstGroupTitle': 'Official scoring has started',
    'dashboard.officialStatus.firstGroupText': 'One group is finalized, and points were awarded by this pool’s rules. More points will update as each group finishes all 6 matches.',
    'dashboard.officialStatus.severalGroupsTitle': 'The table is moving for real',
    'dashboard.officialStatus.severalGroupsText': '{done}/{total} groups are finalized. Scoring keeps updating automatically whenever another group closes.',
    'dashboard.officialStatus.thirdPlacePending': 'Best third-place points will be calculated only after all 12 groups finish, because only then we know the 8 best third-placed teams.',
    'dashboard.dataPending.kicker': 'OFFICIAL CHECK',
    'dashboard.dataPending.badge': 'Finalizing now',
    'dashboard.dataPending.title': 'Finalizing official data',
    'dashboard.dataPending.text': 'We’re verifying the match state and recalculating the new points. For now, the points shown are the last official standings.',
    'dashboard.dataPending.note': 'If the latest result changes the table, standings will update automatically once the calculation is safe to show.',
    'dashboard.liveUpdating.kicker': 'LIVE',
    'dashboard.liveUpdating.badge': 'Live',
    'dashboard.liveUpdating.title': 'Match is live',
    'dashboard.liveUpdating.text': 'The match is live. The Matches screen shows score and minute updates when the live feed is available; official points stay on the last standings until there is a final result.',
    'dashboard.liveUpdating.note': 'If the result changes the points, the table will update automatically after the match ends.',
    'dashboard.resultConfirming.kicker': 'RESULT CHECK',
    'dashboard.resultConfirming.badge': 'Confirming now',
    'dashboard.resultConfirming.title': 'Confirming final result',
    'dashboard.resultConfirming.text': 'The match is over and we’re confirming the final result and advancing team. Official points update once the result is safe to show.',
    'dashboard.resultConfirming.note': 'For now, you’re seeing the last official standings.',
    'dashboard.groupStageComplete.kicker': 'GROUPS COMPLETE',
    'dashboard.groupStageComplete.badge': 'Group points final',
    'dashboard.groupStageComplete.title': 'The tournament has moved to the knockouts',
    'dashboard.groupStageComplete.text': 'Group points are final, and the chase has moved to the knockout stage. Brackets are locked, and every official result can change the table.',
    'dashboard.groupStageComplete.onePhaseText': 'Group points are final, and the bracket you submitted is now live in the knockout stage. Every official result can move the table.',
    'tournamentContext.round.groups': 'Group stage',
    'tournamentContext.round.generic': 'the knockout stage',
    'tournamentContext.round.r32': 'the Round of 32',
    'tournamentContext.round.r16': 'the Round of 16',
    'tournamentContext.round.qf': 'the quarter-finals',
    'tournamentContext.round.sf': 'the semi-finals',
    'tournamentContext.round.thirdPlace': 'the third-place match',
    'tournamentContext.round.final': 'the final',
    'dashboard.tournament.genericKicker': 'TOURNAMENT LIVE',
    'dashboard.tournament.genericBadge': 'Group points final',
    'dashboard.tournament.genericTitle': 'The tournament has moved to the knockouts',
    'dashboard.tournament.genericText': 'Group points are final. We’re keeping the stage label conservative until the current round is verified, and the table will keep moving with official results.',
    'dashboard.tournament.roundKicker': '{round}',
    'dashboard.tournament.roundBadge': 'Group points final',
    'dashboard.tournament.roundTitle': 'The tournament is in {round}',
    'dashboard.tournament.roundText': 'Group points are final, and the chase has moved into {round}. Brackets are locked, and every official result can change the table.',
    'dashboard.tournament.roundOnePhaseText': 'Group points are final, and the bracket you submitted is now live in {round}. Every official result can move the table.',
    'dashboard.tournament.upcomingKicker': 'NEXT ROUND',
    'dashboard.tournament.upcomingTitle': 'Next up: {round}',
    'dashboard.tournament.upcomingText': 'Group points are final. The bracket is between matches right now; the table moves again when {round} results become official.',
    'dashboard.tournament.confirmingBadge': 'Confirming now',
    'dashboard.tournament.confirmingTitle': 'Confirming {round}',
    'dashboard.tournament.confirmingText': 'A recent result is being checked before the table changes. For now, the last official standings stay visible.',
    'dashboard.tournament.completeKicker': 'TOURNAMENT COMPLETE',
    'dashboard.tournament.completeBadge': 'Final standings',
    'dashboard.tournament.completeTitle': 'Final standings are ready',
    'dashboard.tournament.completeText': 'The final is verified and the final table is on screen. Time to open the chat and hand out receipts.',
    ...
    'pundit.tournament.round': 'Group points are official, and the current stage is {round}. Every bracket hit can move the table.',
    'pundit.tournament.upcoming': '{round} is next. Until those results are official, the last table stays clean and clear.',
    'pundit.tournament.confirming': 'A result in {round} is being verified. The table will not jump until the advancer is safe to show.',
    'pundit.tournament.generic': 'Group points are official. We’re keeping the knockout status conservative until the current stage is verified.',
    'pundit.tournament.complete': 'The final is verified and the final standings are ready. Time to hand out receipts in the chat.',
    'pundit.tournament.noStaleExact': 'If the live feed falls behind, FriendlyBet stays on {round} and official results only.',
    'pundit.tournament.noStaleGeneric': 'If the live feed falls behind, FriendlyBet shows cautious status instead of recycling stale updates.',
    'pundit.pool.tournamentRound': 'Group points are official, and {round} is now the heart of this pool. Every bracket hit can move the table.',
    'pundit.pool.tournamentRoundLocked': 'Group points are official, and brackets are locked in {round}. From here, every official result can flip the table.',
    'pundit.pool.tournamentGeneric': 'Group points are official and the knockouts are active. We’ll name the exact round only when the data is safe.',
    'pundit.pool.lockedTournamentRound': 'Predictions are locked, and the pool is live in {round}. Anyone behind needs bracket hits, not more editing time.',
    'pundit.pool.lockedTournamentGeneric': 'Predictions are locked and the knockouts are active. Anyone behind needs bracket points, while the stage label stays cautious until verified.',
    'worldCupStories.kicker': 'Story of the World Cup',
    'worldCupStories.sub': 'Shareable moments from the matches',
    'worldCupStories.share': 'Share image',
    'worldCupStories.previous': 'Previous story',
    'worldCupStories.next': 'Next story',
    'worldCupStories.caption': 'Story of the World Cup on FriendlyBet ⚽',
    'worldCupStories.downloaded': 'Image downloaded — post it to your story',
    ...
    'dashboard.final.kicker': 'Final whistle',
    'dashboard.final.title': '{team} are world champions',
    'dashboard.final.scoreline': '{home} {homeScore} - {awayScore} {away}',
    'dashboard.final.penalties': '{team} won on penalties',
    'dashboard.final.poolWinnersLabel': 'Pool winners',
    'dashboard.final.goldenBootLabel': 'Golden Boot',
    'dashboard.final.winnerListExtra': ' and {n} more',
    'dashboard.final.share': 'Share final image',
    'dashboard.final.previewLoading': 'Final image',
    'dashboard.final.previewAlt': 'Final image for {pool}',
    'dashboard.final.shareCaption': 'The final image for {pool} on FriendlyBet:',
    'dashboard.final.shareDownloaded': 'Final image downloaded and caption copied',
    'dashboard.final.shareUnavailable': 'Final image is not ready yet',
    'dashboard.final.unknownTopScorer': 'Not verified yet',
    'dashboard.final.cardKicker': 'FriendlyBet Final',
    'dashboard.final.cardTitle': '{team} are world champions',
    'dashboard.final.cardWinners': 'Pool winners',
    'dashboard.final.cardGoldenBoot': 'Golden Boot',
    'dashboard.final.cardTagline': 'Free, no signup, no real-money betting',
    ...
    'dashboard.status.verifyingBracket': "The group stage is complete. We're verifying the qualified teams before opening knockout picks.",
    'dashboard.status.fairPlayDelay': 'A tie depends on team-conduct rules. Knockout picks will open only after verification.',
    'dashboard.status.koReady': 'Knockout stage active · 31 matches',
    'dashboard.status.partialKo': 'Picked {n} of 31 · knockout stage active',
    'dashboard.status.completedKo': 'Done · bracket locked',
    'dashboard.twoPhase.waitingKnockout': 'Your group picks are saved. Knockout opens once the official FIFA bracket is final.',
    'dashboard.twoPhase.knockoutOpenTitle': 'Knockout stage active',
    'dashboard.twoPhase.knockoutOpenSub': 'Brackets are locked now. From here, every knockout match can move the table.',
    'dashboard.twoPhase.closedTitle': 'Predictions are locked',
    'dashboard.twoPhase.closedSub': 'The knockout and top-scorer window closed at {time}. You can review what was saved; if an admin opens bracket recovery, it will appear here.',
    'dashboard.twoPhase.closedToast': 'The knockout and top-scorer save window is already closed.',
    ...
    'dashboard.invite.lateKnockoutTitle': 'Invite friends to a knockout pool',
    'dashboard.invite.lateKnockoutSubtitle': 'Groups are locked. Knockout picks lock at {knockoutTime}',
    'dashboard.quickAction.leaderboard': 'Leaderboard',
    'dashboard.quickAction.help': 'Help',
    'dashboard.impact.rank': 'Rank',
    'dashboard.impact.points': 'Points',
    'dashboard.impact.gap': 'Gap',
    'dashboard.impact.openLeaderboard': 'Open leaderboard',
    'dashboard.impact.viewBracket': 'View bracket',
    'dashboard.impact.liveKicker': 'Live now',
    'dashboard.impact.liveTitle': 'Live match and your points',
    'dashboard.impact.confirmingKicker': 'Checking result',
    'dashboard.impact.confirmingTitle': 'Last verified table stays visible',
    'dashboard.impact.idleKicker': 'Points and matches',
    'dashboard.impact.idleTitle': 'Last result and next match',
    'dashboard.impact.idleSub': 'We will update this when another match is on the board',
    'dashboard.impact.statusLive': 'LIVE',
    'dashboard.impact.statusChecking': 'Checking',
    'dashboard.impact.statusNext': 'NEXT',
    'dashboard.impact.statusFinal': 'FINAL',
    'dashboard.impact.lastResult': 'Last result',
    'dashboard.impact.nextMatch': 'Next match',
    'dashboard.impact.ifAdvances': 'If they advance',
    'dashboard.impact.ifTeamAdvances': 'If {team} advance',
    'dashboard.impact.teamAdvanced': '{team} advanced',
    'dashboard.impact.teamEliminated': '{team} knocked out',
    'dashboard.impact.resultPoints': 'You got from {team} advancing',
    'dashboard.impact.resultPending': 'Advancer not verified yet',
    'dashboard.impact.pointsDelta': '+{points}',
    'dashboard.impact.pointsChecking': 'Unavailable',
    'dashboard.impact.pointsUnavailable': 'Unavailable',
    'dashboard.impact.pointsValueOne': '{points} point',
    'dashboard.impact.pointsValueOther': '{points} points',
    'dashboard.impact.scenarioPointsSentence': 'If {team} advance, you get {points} in your pool.',
    'dashboard.impact.resultPointsSentence': 'You got {points} in your pool from {team} advancing.',
    'dashboard.impact.scenarioPointsUnavailable': 'If {team} advance, your pool points will appear after your picks load.',
    'dashboard.impact.resultPointsUnavailable': 'Your points from {team} advancing will appear after your picks load.',
    'dashboard.impact.finalScenarioPointsSentence': 'If {team} win, you get {points} in your pool.',
    'dashboard.impact.finalResultPointsSentence': 'You got {points} in your pool from {team} winning the final.',
    'dashboard.impact.finalScenarioPointsUnavailable': 'If {team} win, your pool points will appear after your picks load.',
    'dashboard.impact.finalResultPointsUnavailable': 'Your points from {team} winning the final will appear after your picks load.',
    'dashboard.impact.noResultYet': 'No verified result to show yet.',
    'dashboard.impact.noNextMatch': 'No next match to show right now.',
    'dashboard.projection.kicker': 'Theoretical table only',
    'dashboard.projection.title': 'If the groups ended right now...',
    'dashboard.projection.sub': 'Jump in and see how the table would look.',
    'dashboard.projection.subWithScore': 'Right now you would be #{rank} with {points} projected points.',
    'dashboard.projection.rank': 'Projected',
    'dashboard.projection.cta': 'See the drama',
    'dashboard.projection.punditMe': 'The Pundit: nice, but one goal can flip the whole thing.',
    'dashboard.projection.punditLeader': 'The Pundit: {name} leads with {points}. Not official, definitely stressful.',
    'dashboard.projection.punditZero': 'The Pundit: no projected points yet, but the board is warming up.',
    'dashboard.drama.fallbackLeader': 'the leader',
    'dashboard.drama.pill.pool': 'Group-chat drama',
    'dashboard.drama.pill.yourMove': 'Your move',
    'dashboard.drama.pill.action': 'Handle now',
    'dashboard.drama.pill.live': 'Live',
    'dashboard.drama.pill.checking': 'Checking points',
    'dashboard.drama.pill.official': 'Official table',
    'dashboard.drama.pill.knockout': 'Knockout',
    'dashboard.drama.meta.pool': '{n} members in the pool',
    'dashboard.drama.meta.leading': '{points} pts and everyone is chasing',
    'dashboard.drama.meta.chasing': '{points} pts · {gap} off first',
    'dashboard.drama.pre.title': 'The pool is warming up before kickoff',
    'dashboard.drama.pre.text': '{n} members are in. Make your picks, drop the link in the chat, and let the trash talk begin.',
    'dashboard.drama.picks.title': 'You are not in the drama yet',
    'dashboard.drama.picks.text': 'Finish your picks before the group starts moving. After that, you are chasing the chat.',
    'dashboard.drama.lateKnockout.title': 'Knockout picks are open, no warm-up time',
    'dashboard.drama.lateKnockout.text': 'Fill your bracket by {time}. From here, every match can throw the table sideways.',
    'dashboard.drama.recovery.title': 'First, save the pick situation',
    'dashboard.drama.recovery.text': 'There is an action to finish so your predictions are safe. The drama can wait one minute.',
    'dashboard.drama.admin.title': 'You have a message for the group',
    'dashboard.drama.admin.text': 'Some members need to come back or complete picks. Time to wake up the chat.',
    'dashboard.drama.live.title': 'Matches are moving, the table is waiting',
    'dashboard.drama.live.text': '{done}/{total} group matches are finished or in motion. Official points land when a full group closes.',
    'dashboard.drama.checking.title': 'Last official table is showing, new points are being checked',
    'dashboard.drama.checking.text': 'A result may move the table. Until confirmation is safe, this shows the last official standings.',
    'dashboard.drama.officialLeader.title': 'You lead. Everyone else is chasing.',
    'dashboard.drama.officialLeader.text': 'You are first with {points} pts. Every next round is a chance for the group to catch you.',
    'dashboard.drama.officialChaser.title': 'You are #{rank}. Still very much alive.',
    'dashboard.drama.officialChaser.text': '{gap} pts behind {leader}. One good hit and the chat can flip.',
    'dashboard.drama.knockout.title': 'Knockouts are live. Every match can flip the chat.',
    'dashboard.drama.knockout.text': 'You are #{rank} with {points} pts. From here, every advancer can change the story.',
    'dashboard.drama.knockoutNoRank.title': 'The knockouts reopen the drama',
    'dashboard.drama.knockoutNoRank.text': 'The groups are behind us. Now every knockout match can move the table.',
    'dashboard.drama.tournamentRound.title': 'The tournament is in {round}',
    'dashboard.drama.tournamentRound.text': 'The official table is live. Every advancer in {round} can flip the chat.',
    'dashboard.drama.tournamentUpcoming.title': 'The next round is on deck',
    'dashboard.drama.tournamentUpcoming.text': '{round} is waiting for the next official results. Until then, the last table stays steady.',
    'dashboard.drama.tournamentConfirming.title': 'Checking a result in {round}',
    'dashboard.drama.tournamentConfirming.text': 'The last official table stays visible until verification is safely closed.',
    'dashboard.drama.tournamentGeneric.title': 'The tournament is live, and the status is cautious',
    'dashboard.drama.tournamentGeneric.text': 'Group points are final. We’ll name the exact round only when the data is safe, with no stale update dressed up as live.',
    'dashboard.drama.tournamentComplete.title': 'This pool has reached full time',
    'dashboard.drama.tournamentComplete.text': 'The final is verified and the final standings are ready. Now the chat can argue about who knew it all along.',
    'dashboard.drama.action.pick': 'Enter your picks',
    'dashboard.drama.action.fix': 'Fix picks',
    'dashboard.drama.action.members': 'View members',
    'dashboard.drama.action.leaderboard': 'Open leaderboard',
    'dashboard.drama.action.projection': 'See the drama',
    'dashboard.drama.metric.members': 'Members',
    'dashboard.drama.metric.lock': 'Locks',
    'dashboard.drama.metric.action': 'Action',
    'dashboard.drama.metric.lastRank': 'Last rank',
    'dashboard.drama.metric.rank': 'Rank',
    'dashboard.drama.metric.points': 'Points',
    'dashboard.drama.metric.status': 'Status',
    'dashboard.drama.metric.leaderValue': 'Leading',
    'dashboard.drama.metric.behind': 'Behind',
    'dashboard.drama.metric.groups': 'Groups',
    'dashboard.drama.metric.matches': 'Matches',
    ...
    'dashboard.menu.primary': 'Main',
    'dashboard.menu.myPrediction': 'My prediction',
    'dashboard.menu.pool': 'Pool',
    'dashboard.menu.account': 'Account',
    'dashboard.menu.support': 'Support',
    'dashboard.menu.exitSection': 'Exit',
    ...
    'leaderboard.participantsList': 'Pool participants',
    ...
    'leaderboard.statusLiveNoOfficial': 'Live - points unlock when a full group finishes',
    'leaderboard.statusOfficialStarted': 'Official scoring live - {groups}/{total} groups finalized',
    'leaderboard.statusGroupsComplete': 'Knockout stage active - the leaderboard moves with official results',
    'leaderboard.statusTournamentRound': '{round} is underway - the leaderboard moves with every official result',
    'leaderboard.statusTournamentUpcoming': 'Next up: {round} - standings move with the next official result',
    'leaderboard.statusTournamentConfirming': 'Confirming a result in {round} - showing the last official standings',
    'leaderboard.statusTournamentGeneric': 'Knockout stage active - showing cautious status until the stage is verified',
    'leaderboard.statusTournamentComplete': 'Tournament complete - final standings are showing',
    'leaderboard.statusDataPending': 'Finalizing official data - showing the last official standings',
    'leaderboard.emptyLiveNoOfficialTitle': 'Matches are already underway',
    'leaderboard.emptyLiveNoOfficialText': 'No official points in this pool yet. Group points are awarded only when a full group finishes all 6 matches.',
    'leaderboard.emptyOfficialZeroTitle': 'Official scoring is live',
    'leaderboard.emptyOfficialZeroText': '{groups} of {total} groups are complete. If this pool still has 0 points, nobody hit the group scoring yet; the next chase is through the knockouts.',
    'leaderboard.emptyDataPendingTitle': 'Standings are updating',
    'leaderboard.emptyDataPendingText': 'A match is under official verification. This pool has no official points yet, and the table will update once recalculation is done.',
    'leaderboard.calculatingShort': '...',
    'leaderboard.calculatingLabel': 'Finalizing',
    'leaderboard.lastOfficialLabel': 'Last official',
    'leaderboard.calculatingBreakdown': 'Official data is being finalized',
    'leaderboard.thirdPlacePending': 'Best third-place points will be calculated only after all 12 groups finish, because only then we know the 8 best third-placed teams.',
    'leaderboard.podiumEmpty': 'Empty',
    'leaderboard.noPointsYet': 'No points yet',
    'leaderboard.banter.tournamentLeader': '{name} leads with {points} pts while {round} is underway. Every official result can change the chase now.',
    'leaderboard.banter.tournamentGenericLeader': '{name} leads with {points} pts while the knockouts are active. We’ll stay cautious until the current stage is verified.',
    'leaderboard.banter.tournamentHeadline': 'Group points are official, and {round} is now the story. From here the leaderboard moves through the bracket, champion pick, and top scorer.',
    'leaderboard.banter.tournamentGeneric': 'Group points are official and the knockouts are active. Showing cautious status until the current stage is verified.',
    'leaderboard.banter.tournamentChase': 'No more theoretical group table. Anyone behind needs hits in {round}, not excuses.',
    'leaderboard.banter.tournamentGenericChase': 'No more theoretical group table. Anyone behind needs knockout points, and the app will not pass stale updates off as live.',
    ...
    'leaderboard.projection.kicker': 'Theoretical table only',
    'leaderboard.projection.title': 'The theoretical podium',
    'leaderboard.projection.pill': 'Not official',
    'leaderboard.projection.note': 'No projection points are counted. This is only "what would happen if the groups ended right now."',
    'leaderboard.projection.source': 'Based on {groups} of {total} groups already in motion, using final results or trusted live scores.',
    'leaderboard.projection.points': 'Projected',
    'leaderboard.projection.groupHits': '{n} current group hits',
    'leaderboard.projection.officialStillZero': 'Not official scoring',
    'leaderboard.projection.punditMe': 'The Pundit: right now you would be #{rank} with {points}. Screenshot it before Group C ruins the party.',
    'leaderboard.projection.punditLeader': 'The Pundit: {name} sits on the theoretical throne with {points}. One goal and the crown drops.',
    'leaderboard.projection.punditZero': 'The Pundit: no theoretical points yet, but one goal can open the drama.',
    'leaderboard.projection.shareButton': 'Share podium image',
    'leaderboard.projection.shareCaption': 'The theoretical podium for {pool} on FriendlyBet. Not official scoring, just live drama.',
    'leaderboard.projection.shareDownloaded': 'Podium image downloaded and caption copied',
    'leaderboard.projection.shareUnavailable': 'The theoretical podium is not ready to share yet',
    'leaderboard.projection.placeFirst': '1st',
    'leaderboard.projection.placeSecond': '2nd',
    'leaderboard.projection.placeThird': '3rd',
    'leaderboard.projection.cardKicker': 'THEORETICAL TABLE ONLY',
    'leaderboard.projection.cardTitle': 'If the groups ended right now',
    'leaderboard.projection.cardNote': 'Temporary podium from {groups} active groups',
    'leaderboard.projection.cardDisclaimer': 'Not official scoring',
    'leaderboard.projection.cardTagline': 'One goal can flip the whole table',
    ...
    'poolFound.statusLateKnockoutOpen': 'Knockout pool open until {time}',
    ...
    'sharePool.shareTextLateKnockout': 'You\'ve been invited to the "{poolName}" knockout pool 🏆\n\nThe group stage is already locked, but you can join now and fill the knockout bracket until {knockoutTime}.\n\nJoin code: {code}\n👉 {url}\n\n⚽ FriendlyBet — World Cup Predictions with Friends',
    'bracketShare.cta': 'Share my bracket',
    'bracketShare.imageCta': 'Share the victory image',
    'bracketShare.fullPredictionCta': 'Share the full prediction',
    'bracketShare.summaryHelper': 'Start by sharing the victory image. Anyone who wants can also share the full prediction.',
    'bracketShare.imageTitle': 'My Road to Victory',
    'bracketShare.fullPredictionTitle': 'My full World Cup 2026 prediction',
    'bracketShare.imageOnlyDownloaded': 'Image downloaded',
    ...
    'groups.current.compare': 'Compare with current group',
    'groups.current.aria': 'Current Group {letter} standings',
    'groups.current.actual': 'Current',
    'groups.current.pointsShort': 'Pts',
    'groups.current.playedShort': 'P',
    'groups.current.noFinalResults': 'No final group results yet',
    ...
    'knockoutEx.notOpenExact': 'Knockout is not open yet. It opens only once the official FIFA bracket is final.',
    ...
    // === Matches extras ===
    'matchesEx.filterTimeline': 'Timeline',
    'matchesEx.filterNext': 'Next',
    'matchesEx.filterResults': 'Results',
    ...
    'matchesEx.liveResultAfterFinal': 'Match is live. Official points update after full-time.',
    'matchesEx.liveFeedConnectingNote': 'Match is live. Connecting to the live score and minute.',
    'matchesEx.verifyingResult': 'Confirming official result',
    'matchesEx.resultBeingVerified': 'Official data is being finalized now',
    'matchesEx.statusBeingVerified': 'We’re checking the match state. Until it is reliable, we won’t show a stale or unfinished result.',
    'matchesEx.finalBeingConfirmed': 'Confirming final result',
    'matchesEx.finalBeingConfirmedNote': 'We’re confirming the final result and advancing team. Points update only after verification finishes.',
    'matchesEx.liveScoreUpdatingNote': 'Match is live. Connecting to the live score and minute.',
    'matchesEx.liveStatusUpdatingNote': 'We’re checking the latest match state. Until it is reliable, we won’t show a stale score.',
    ...
    'matchesEx.officialUpdated': 'Official schedule: {time}',
    ...
    'matchesEx.yesterday': 'Yesterday',
    'matchesEx.today': 'Today',
    'matchesEx.tomorrow': 'Tomorrow',
    'matchesEx.currentAnchor': 'Current tournament moment',
    'matchesEx.matchNumberShort': 'Match {n}',
    'matchesEx.nowChecking': 'Finalizing official data',
    'matchesEx.nowCheckingSub': 'Checking match state and recalculating points before showing a result',
    'matchesEx.nowLive': '{n} live now',
    'matchesEx.nowNext': 'Next match',
    'matchesEx.nowComplete': 'No active matches right now',
    'matchesEx.nextMatchLabel': 'Next',
    'matchesEx.latestResultLabel': 'Latest result',
    'matchesEx.checkingMatchLabel': 'Checking',
    'matchesEx.statusLabel': 'Status',
    'matchesEx.finalizingShort': 'Finalizing',
    'matchesEx.tournamentProgressLabel': 'Progress',
    'matchesEx.tournamentProgressValue': '{finished}/{total}',
    'matchesEx.noneShort': 'None',
    'matchesEx.jumpNow': 'Now',
    'matchesEx.jumpToday': 'Today',
    'matchesEx.jumpNext': 'Next',
    'matchesEx.jumpResults': 'Results',
    ...
    'matchesEx.stageR32': 'Round of 32',
    ...
    'tsLocked.closedTitle': 'Top scorer window closed',
    'tsLocked.closedSubtitle': 'New top-scorer picks cannot be saved after {time}',
    'tsLocked.closedWhy': 'Why is it locked?',
    'tsLocked.closedWhyText': 'This pool’s top-scorer window closed at {time}, after the knockouts began.',
    'tsLocked.closedHow': 'Can it reopen?',
    'tsLocked.closedHowText': 'Not automatically. Post-deadline recovery is bracket-only, and only when the admin opens a recovery window.',
    'tsLocked.closedWhat': 'What can I do now?',
    'tsLocked.closedWhatText': 'Return to the dashboard and review what was saved. If the admin opens knockout recovery for you, a dedicated button will appear there.',
    'tsLocked.closedStatus': 'Window closed',
    ...
    'membersList.r16IncidentTitle': 'Members who need to refill',
    'membersList.r16IncidentText': '{n} member(s) filled the knockout before the bracket fix. They are marked at the top of the list.',
    'membersList.r16IncidentFlag': 'Needs knockout refill',
    'membersList.r16IncidentClosedTitle': 'Members affected by the correction',
    'membersList.r16IncidentClosedText': '{n} member(s) filled the knockout before the bracket fix. The refill window is now closed, and they remain marked at the top of the list.',
    'membersList.r16IncidentClosedFlag': 'Refill window closed',
    'membersList.r16IncidentLoadError': 'Could not load affected-member flags',
    ...
    'errors.poolClosedKnockout': '🔒 This knockout pool closed when the knockout stage began ({knockoutTime}).',
    'errors.lateEntryClosed': '🔒 New pools cannot be created after any team starts its second match ({time}).',
    'errors.lateKnockoutCreationClosed': '🔒 New knockout pools cannot be created after the knockout stage begins ({time}).',
    ...
    'wizard.multipliers.lateKnockoutNote': 'In late knockout pools, multipliers apply only to knockout picks.',
    ...
    'betting.summary.warningLate': 'This late-entry pool is still open. You can edit your predictions until {time}.',
    'betting.summary.warningLateKnockout': 'This is a late knockout pool. The group stage is locked, and you can edit your bracket until {knockoutTime}.',
    'lateKnockout.waitingToast': 'The group stage is still open. Knockout picks will open when the groups are complete.',
    ...
    'betting.summary.editPrediction': 'Edit prediction',
    ...
    'dashboard.continueCta.lateKnockout': '{n} of {total} knockout picks complete',
    ...
    'dashboard.viewCta.lateKnockoutSubtitle': 'You can update your bracket until {time}',
    'dashboard.viewCta.reviewSubtitle': 'The review window is open — check or update your knockout bracket',
    'dashboard.lateKnockout.waitingTitle': 'Knockout opens after the groups',
    'dashboard.lateKnockout.waitingSubtitle': 'Group-stage picks are already locked. Invite friends now; the bracket opens when all groups are complete.',
    'dashboard.lateKnockout.startTitle': 'Start your knockout picks',
    'dashboard.lateKnockout.startSubtitle': 'Fill your bracket before {time}',
    'wizard.lateKnockout.title': 'Knockout pool',
    'wizard.lateKnockout.subtitle': 'The group stage is already locked. Choose the scoring for the knockout bracket.',
    'wizard.lateKnockout.notice': 'This pool opens for knockout picks when the groups are complete. Picks lock at {time}.',
    'wizard.lateKnockout.modeTitle': 'Knockout pool',
