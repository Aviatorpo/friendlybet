...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.adminNudge.title': 'ל-{n} מחברי הפול חסר שלב הנוקאאוט',
    'dashboard.adminNudge.sub': 'עקב באג, אצל חלק מהחברים שלב הנוקאאוט לא נשמר (הבתים והאלופה כן). התקלה הייתה שקטה — לכן כשתתזכר את הקבוצה, בקש שגם מי שבטוח שסיים ייכנס שוב ויוודא שהבראקט שלו נשמר, אחרת יפסידו את רוב הנקודות. ההודעה המוכנה כוללת את זה.',
    ...
    'adminMembersEx.needsKnockoutGlitch': 'אנו מתנצלים על התקלה — עקב באג טכני, שלב הנוקאאוט (הבראקט) של {n} משתתפים לא נשמר (הבחירות של הבתים והאלופה שלהם כן נשמרו). כדאי ליצור איתם קשר ולבקש שישלימו את הבראקט לפני תחילת המונדיאל. הם מסומנים למטה.',
    'adminMembersEx.copyNudge': 'העתק הודעה לקבוצה',
    'adminMembersEx.nudgeMessage': 'היי לכולם! 👋 בגלל תקלה טכנית, אצל חלק מהמשתתפים שלב הנוקאאוט (הבראקט) לא נשמר — בחירות הבתים והאלופה כן נשמרו. ⚠️ חשוב: התקלה הייתה שקטה, אז גם אם אתם בטוחים שסיימתם — אנא היכנסו שוב ל-friendlybet.live ובדקו ששלב הנוקאאוט שלכם נשמר במלואו, והשלימו אותו אם משהו חסר, לפני שהמונדיאל מתחיל. מצטערים על אי הנוחות! 🙏',
  ...
  en: {
    ...
    'dashboard.adminNudge.title': '{n} member(s) in your pool are missing their knockout',
    'dashboard.adminNudge.sub': 'Due to a bug, some members’ knockout stage didn’t save (groups & champion did). The glitch was silent — so when you remind the group, tell everyone (even those sure they finished) to re-open and verify their bracket saved, or they’ll miss most of the points. The ready-made message says this.',
    ...
    'adminMembersEx.needsKnockoutGlitch': 'We\'re sorry for the glitch — due to a technical bug, {n} member(s)\' knockout stage (bracket) wasn\'t saved (their group & champion picks were saved). Please reach out and ask them to complete their bracket before the World Cup starts. They\'re flagged below.',
    'adminMembersEx.copyNudge': 'Copy a message to send',
    'adminMembersEx.nudgeMessage': 'Hey everyone! 👋 Due to a technical glitch, the knockout stage (bracket) didn\'t save for some of us — group and champion picks were saved. ⚠️ Important: the glitch was silent, so even if you\'re sure you finished — please head back to friendlybet.live and double-check your full knockout bracket is saved, and complete it if anything\'s missing, before the World Cup starts. Sorry for the inconvenience! 🙏',
