...
const TRANSLATIONS = {
  he: {
    ...
    'errors.lateEntryClosed': '🔒 אי אפשר ליצור הימורים חדשים אחרי תחילת המשחק השני של קבוצה כלשהי',
  ...
  en: {
    ...
    'errors.lateEntryClosed': '🔒 New pools cannot be created after any team starts its second match',
