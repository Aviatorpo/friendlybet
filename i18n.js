...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.liveStatus.lateKnockoutTitle': 'הבתים הסתיימו - הנוקאאוט פתוח',
    'dashboard.liveStatus.lateKnockoutText': 'אין כאן ניקוד על הבתים או מלך השערים. מלאו את הבראקט עד תחילת משחק הנוקאאוט הראשון ({time}).',
    ...
    'dashboard.groupStageComplete.title': 'שלב הבתים הסתיים',
    'dashboard.groupStageComplete.text': 'כל הבתים הושלמו והניקוד הרשמי של שלב הבתים נכנס. הנוקאאוט פתוח עד תחילת משחק הנוקאאוט הראשון ({time}).',
    'dashboard.groupStageComplete.onePhaseText': 'כל הבתים הושלמו והניקוד הרשמי של שלב הבתים נכנס. בהימור חד-שלבי הבחירות שלך כבר נעולות; שלב הנוקאאוט ימשיך לפי הבראקט שמילאת מראש.',
    'pundit.title': 'הפרשן',
    ...
    'dashboard.status.koReady': 'פתוח עד {time} · 31 משחקים',
    'dashboard.status.partialKo': 'הימרת על {n} מתוך 31 · פתוח עד {time}',
    'dashboard.status.completedKo': 'הושלם · אפשר לעדכן עד {time}',
    'dashboard.twoPhase.waitingKnockout': 'בחירות הבתים נשמרו. הנוקאאוט ייפתח כשהבראקט הרשמי יהיה סופי לפי FIFA.',
    'dashboard.twoPhase.knockoutOpenTitle': 'הנוקאאוט פתוח',
    'dashboard.twoPhase.knockoutOpenSub': 'ההימור על הנוקאאוט פתוח עד תחילת משחק הנוקאאוט הראשון ({time}). בחרו מנצחת בכל משחק; כל בחירה נשמרת מיד.',
    ...
    'leaderboard.statusGroupsComplete': 'שלב הבתים הסתיים - מכאן הלידרבורד עובר לנוקאאוט',
  ...
  en: {
    ...
    'dashboard.liveStatus.lateKnockoutTitle': 'Groups are complete - knockout is open',
    'dashboard.liveStatus.lateKnockoutText': 'There are no group-stage or top-scorer points here. Fill the bracket before the first knockout match starts ({time}).',
    ...
    'dashboard.groupStageComplete.title': 'The group stage is complete',
    'dashboard.groupStageComplete.text': 'All groups are finalized and official group-stage points are in. Knockout picks are open until the first knockout match starts ({time}).',
    'dashboard.groupStageComplete.onePhaseText': 'All groups are finalized and official group-stage points are in. In one-phase pools, your picks are already locked; the knockout stage continues from the bracket you submitted earlier.',
    ...
    'dashboard.status.koReady': 'Open until {time} · ready to predict 31 matches',
    'dashboard.status.partialKo': 'Picked {n} of 31 · open until {time}',
    'dashboard.status.completedKo': 'Done · editable until {time}',
    'dashboard.twoPhase.waitingKnockout': 'Your group picks are saved. Knockout opens once the official FIFA bracket is final.',
    'dashboard.twoPhase.knockoutOpenTitle': 'Knockout is open',
    'dashboard.twoPhase.knockoutOpenSub': 'Knockout picks are open until the first knockout match starts ({time}). Pick a winner in every match; each pick saves immediately.',
    ...
    'leaderboard.statusGroupsComplete': 'Group stage complete - the leaderboard moves to knockouts now',
