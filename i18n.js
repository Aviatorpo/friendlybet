...
const TRANSLATIONS = {
  he: {
    ...
    'reopen.user.preKickoffTitle': 'חשוב: בדוק את הנוקאאוט כדי לא לאבד נקודות',
    'reopen.user.preKickoffSub': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. חלק מבחירות הנוקאאוט שלך עלולות להיות מול יריבות לא נכונות, ובחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. אנא בדוק ותקן עכשיו.',
    'reopen.user.preKickoffSubHard': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך מסומן ככזה שיש בו לפחות בחירה אחת מול משחק שלא קיים בבראקט המתוקן. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. אנא בדוק ותקן עכשיו.',
    'reopen.user.preKickoffSubPool': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך לא מסומן כנפגע ישירות, אבל הפול שלך נפגע ולכן כדאי לבדוק שהנוקאאוט שלך עדיין מתאים לבראקט הרשמי המתוקן. בחירות שלא יתאימו יקבלו 0 נקודות.',
    ...
    'reopen.user.approvedTitle': 'חשוב: תקן את הנוקאאוט כדי לא לאבד נקודות',
    'reopen.user.approvedSub': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. חלק מבחירות הנוקאאוט שלך עלולות להיות מול יריבות לא נכונות. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
    'reopen.user.approvedSubHard': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך מסומן ככזה שיש בו לפחות בחירה אחת מול משחק שלא קיים בבראקט המתוקן. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
    'reopen.user.approvedSubPool': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך לא מסומן כנפגע ישירות, אבל הפול שלך נפגע ולכן מומלץ לבדוק שהנוקאאוט שלך עדיין מתאים לבראקט הרשמי המתוקן. בחירות שלא יתאימו יקבלו 0 נקודות. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
    'reopen.user.cta': 'תקן את הנוקאאוט →',
    ...
    'reopen.admin.copyBtn': '📋 העתק הודעה אישית ל{name}',
    ...
    'reopen.admin.personalMsg': 'היי {name}! 👋 סליחה, תיקנו שגיאה בשיבוץ קבוצות מהמקום השלישי בנוקאאוט של FriendlyBet. פתחתי לך 7 ימים לבדוק/לתקן רק את הנוקאאוט — בחירות הבתים ומלך השערים נשארות כמו שהיו. היכנס ל-friendlybet.live ובדוק את הבראקט. תודה 🙏',
    ...
    'adminMembersEx.annexReview': '⚠️ חלון בדיקה',
    'adminMembersEx.annexHardAffected': '⚠️ נפגע ישירות',
    ...
    'adminMembersEx.annexCReviewGlitch': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של FIFA לקבוצות מהמקום השלישי. {n} משתתפים בפול הזה קיבלו חלון של 7 ימים לבדוק/לתקן את הנוקאאוט. מתוכם {hard} כבר מסומנים כמי שבחרו לפחות משחק אחד שלא קיים בבראקט המתוקן. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות.',
    'adminMembersEx.annexPoolCount': '{n} עם חלון תיקון',
    'adminMembersEx.annexHardCount': '{n} נפגעו ישירות',
    'adminMembersEx.annexReminderCount': '{n} לתזכורת',
    'adminMembersEx.annexYouHard': 'גם הבראקט שלך מסומן כנפגע ישירות — כדאי לבדוק ולתקן אותו.',
    ...
    'adminMembersEx.copyNudge': 'העתק הודעה לקבוצה',
    'adminMembersEx.viewAffectedMembers': 'ראה משתתפים מסומנים',
    'adminMembersEx.reviewMyBracket': 'בדוק את הבראקט שלי',
    'adminMembersEx.nudgeMessage': 'היי לכולם, סליחה באמת — FriendlyBet תיקן שגיאה בשיבוץ הרשמי של FIFA לקבוצות מהמקום השלישי בנוקאאוט. בגלל זה חלק מבחירות הנוקאאוט עלולות להיות מול יריבות לא נכונות, ובחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. בבקשה היכנסו עכשיו ל-friendlybet.live ובדקו/תקנו את שלב הנוקאאוט. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות; רק הנוקאאוט פתוח בחלון התיקון. תודה וסליחה על הטרחה 🙏',
  ...
  en: {
    ...
    'reopen.user.preKickoffTitle': 'Important: review knockout to avoid losing points',
    'reopen.user.preKickoffSub': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Some knockout picks may now be against the wrong opponents, and picks that do not match the corrected official bracket will score 0 points. Please review and fix them now.',
    'reopen.user.preKickoffSubHard': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is flagged as having at least one pick for a match that does not exist in the corrected bracket. Picks that do not match the corrected official bracket will score 0 points. Please review and fix them now.',
    'reopen.user.preKickoffSubPool': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is not directly flagged, but your pool was affected, so please review that your knockout still matches the corrected official bracket. Picks that do not match it will score 0 points.',
    ...
    'reopen.user.approvedTitle': 'Important: fix knockout to avoid losing points',
    'reopen.user.approvedSub': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Some knockout picks may now be against the wrong opponents. Picks that do not match the corrected official bracket will score 0 points. Your group picks, third-place teams, and top scorer stay locked.',
    'reopen.user.approvedSubHard': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is flagged as having at least one pick for a match that does not exist in the corrected bracket. Picks that do not match the corrected official bracket will score 0 points. Your group picks, third-place teams, and top scorer stay locked.',
    'reopen.user.approvedSubPool': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is not directly flagged, but your pool was affected, so please review that your knockout still matches the corrected official bracket. Picks that do not match it will score 0 points. Your group picks, third-place teams, and top scorer stay locked.',
    'reopen.user.cta': 'Fix knockout picks →',
    ...
    'reopen.admin.copyBtn': '📋 Copy a personal message for {name}',
    ...
    'reopen.admin.personalMsg': 'Hi {name}! 👋 Sorry, we corrected an error in FriendlyBet’s third-place knockout pairings. I opened 7 days for you to review/edit only the knockout bracket — your group picks and top scorer stay as they were. Please open friendlybet.live and check your bracket. Thanks 🙏',
    ...
    'adminMembersEx.annexReview': '⚠️ Review window',
    'adminMembersEx.annexHardAffected': '⚠️ Directly affected',
    ...
    'adminMembersEx.annexCReviewGlitch': 'We’re genuinely sorry — FriendlyBet corrected an error in FIFA’s official third-place pairing table. {n} member(s) in this pool now have 7 days to review/edit the knockout bracket. {hard} are already flagged as having at least one pick for a match that does not exist in the corrected bracket. Picks that do not match the corrected official bracket will score 0 points.',
    'adminMembersEx.annexPoolCount': '{n} review window',
    'adminMembersEx.annexHardCount': '{n} directly affected',
    'adminMembersEx.annexReminderCount': '{n} to remind',
    'adminMembersEx.annexYouHard': 'Your own bracket is directly affected too — please review and fix it.',
    ...
    'adminMembersEx.copyNudge': 'Copy a message to send',
    'adminMembersEx.viewAffectedMembers': 'View flagged members',
    'adminMembersEx.reviewMyBracket': 'Review my bracket',
    'adminMembersEx.nudgeMessage': 'Hey everyone, we’re genuinely sorry — FriendlyBet corrected an error in FIFA’s official third-place knockout pairings. Because of this, some knockout picks may now be against the wrong opponents, and picks that do not match the corrected official bracket will score 0 points. Please reopen friendlybet.live now and review/fix your knockout bracket. Your group picks, third-place teams, and top scorer stay locked; only knockout is open during the correction window. Thank you, and sorry for the hassle 🙏',
