...
const TRANSLATIONS = {
  he: {
    ...
    'adminMembersEx.annexCReviewGlitch': 'סליחה באמת. FriendlyBet הציג בפול הזה חלק מהקבוצות מהמקום השלישי במשחקי נוקאאוט לא נכונים. {n} חברים קיבלו עכשיו חלון בדיקה כדי לבדוק או לתקן את הבראקט שלהם. {hard} חברים כבר מסומנים כמי שיש להם לפחות בחירה אחת למשחק שכבר לא קיים בבראקט המתוקן. בחירות שלא יתאימו לבראקט הרשמי המתוקן עלולות לקבל 0 נקודות.',
  ...
  en: {
    ...
    'adminMembersEx.annexCReviewGlitch': 'We’re genuinely sorry. FriendlyBet showed some third-place teams in the wrong knockout matches for this pool. {n} member(s) now have a review window to check or fix their knockout bracket. {hard} member(s) are already flagged as having at least one pick for a matchup that no longer exists in the corrected bracket. Picks that don’t match the corrected official bracket may score 0 points.',
