...
const TRANSLATIONS = {
  he: {
    ...
    'reopen.user.preKickoffSubHard': 'סליחה באמת — זו הייתה טעות שלנו ב-FriendlyBet בשיבוץ קבוצות מהמקום השלישי, ולכן חלק ממשחקי הנוקאאוט שהוצגו לך היו לא נכונים. הבראקט שלך כולל לפחות בחירה אחת למשחק שלא קיים בבראקט המתוקן. אנא בחר/י מחדש את שלב הנוקאאוט עכשיו. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות.',
    'reopen.user.preKickoffSubPool': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך לא מסומן כשבור, אבל כדי לשמור על הוגנות כל חברי הפול קיבלו את אותו חלון בדיקה כי חלק מהחברים צריכים זמן נוסף. אפשר לבדוק/לערוך את הנוקאאוט עכשיו מול הבראקט הרשמי המתוקן.',
    ...
    'reopen.user.approvedSubHard': 'סליחה באמת — זו הייתה טעות שלנו ב-FriendlyBet בשיבוץ קבוצות מהמקום השלישי, ולכן חלק ממשחקי הנוקאאוט שהוצגו לך היו לא נכונים. הבראקט שלך כולל לפחות בחירה אחת למשחק שלא קיים בבראקט המתוקן. אנא בחר/י מחדש את שלב הנוקאאוט עכשיו. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
    'reopen.user.approvedSubPool': 'סליחה באמת — תיקנו שגיאה בשיבוץ הרשמי של קבוצות מהמקום השלישי. הבראקט שלך לא מסומן כשבור, אבל כדי לשמור על הוגנות כל חברי הפול קיבלו את אותו חלון בדיקה כי חלק מהחברים צריכים זמן נוסף. אפשר לבדוק/לערוך את הנוקאאוט עכשיו מול הבראקט הרשמי המתוקן. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
    ...
    'adminMembersEx.annexCReviewGlitch': 'סליחה באמת — זו הייתה טעות שלנו ב-FriendlyBet. השתמשנו בלוגיקת שיבוץ לא נכונה לקבוצות מהמקום השלישי, ולכן חלק ממשחקי הנוקאאוט שהוצגו בפול הזה היו לא נכונים. {n} משתתפים בפול הזה קיבלו חלון של 7 ימים לבדוק/לתקן את הנוקאאוט. מתוכם {hard} כבר מסומנים כמי שבחרו לפחות משחק אחד שלא קיים בבראקט המתוקן. בחירות שלא יתאימו לבראקט הרשמי המתוקן יקבלו 0 נקודות.',
  ...
  en: {
    ...
    'reopen.user.preKickoffSubHard': 'We’re genuinely sorry — this was our mistake at FriendlyBet. We used the wrong third-place pairing logic, so some knockout matchups shown to you were wrong. Your bracket has at least one pick for a match that does not exist in the corrected bracket. Please choose your knockout again now. Picks that do not match the corrected official bracket will score 0 points.',
    'reopen.user.preKickoffSubPool': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is not flagged as broken, but for fairness everyone in this affected pool gets the same knockout review window because some members need extra time. You can review/edit knockout now against the corrected official bracket.',
    ...
    'reopen.user.approvedSubHard': 'We’re genuinely sorry — this was our mistake at FriendlyBet. We used the wrong third-place pairing logic, so some knockout matchups shown to you were wrong. Your bracket has at least one pick for a match that does not exist in the corrected bracket. Please choose your knockout again now. Picks that do not match the corrected official bracket will score 0 points. Your group picks, third-place teams, and top scorer stay locked.',
    'reopen.user.approvedSubPool': 'We’re genuinely sorry — we corrected an error in the official third-place pairings. Your bracket is not flagged as broken, but for fairness everyone in this affected pool gets the same knockout review window because some members need extra time. You can review/edit knockout now against the corrected official bracket. Your group picks, third-place teams, and top scorer stay locked.',
    ...
    'adminMembersEx.annexCReviewGlitch': 'We’re genuinely sorry — this was our mistake at FriendlyBet. We used the wrong third-place pairing logic, so some knockout matchups shown in this pool were wrong. {n} member(s) in this pool now have 7 days to review/edit the knockout bracket. {hard} are already flagged as having at least one pick for a match that does not exist in the corrected bracket. Picks that do not match the corrected official bracket will score 0 points.',
