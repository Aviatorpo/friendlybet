...
const TRANSLATIONS = {
  he: {
    ...
    'leaderboard.statusGroupsComplete': 'שלב הבתים הושלם - ניקוד הבתים סופי',
    ...
    'leaderboard.emptyOfficialZeroText': 'הושלמו {groups} מתוך {total} בתים, אבל בפול הזה עדיין אין נקודות. הרשימה למטה היא רשימת משתתפים, לא דירוג סופי.',
  ...
  en: {
    ...
    'leaderboard.statusGroupsComplete': 'Group stage complete - group points are final',
    ...
    'leaderboard.emptyOfficialZeroText': '{groups} of {total} groups are complete, but this pool still has 0 points. The list below is participants, not a final ranking.',
