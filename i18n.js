...
const TRANSLATIONS = {
  he: {
    ...
    'reopen.user.preKickoffTitle': '✅ מומלץ לבדוק את הנוקאאוט לפני הנעילה',
    'reopen.user.preKickoffSub': 'סליחה — תיקנו שגיאה בשיבוץ קבוצות מהמקום השלישי. אפשר לבדוק/לתקן עכשיו את הנוקאאוט לפני תחילת הטורניר. אחרי הנעילה יישארו לך 7 ימים לנוקאאוט בלבד.',
    'reopen.user.preKickoffCta': 'בדוק/תקן עכשיו →',
    'reopen.user.preKickoffPendingTitle': '⚠️ ייתכן שצריך לבדוק את הנוקאאוט',
    'reopen.user.preKickoffPendingSub': 'סליחה — תיקנו שגיאה בשיבוץ קבוצות מהמקום השלישי. אפשר עדיין לבדוק את הנוקאאוט לפני הנעילה.',
    'reopen.user.approvedTitle': '✅ הנוקאאוט פתוח לבדיקה ותיקון',
    'reopen.user.approvedSub': 'סליחה — תיקנו שגיאה בשיבוץ קבוצות מהמקום השלישי בנוקאאוט. אנא בדוק את הבראקט שלך. בחירות הבתים, הקבוצות מהמקום השלישי ומלך השערים נשארות נעולות.',
    'reopen.user.cta': 'בדוק/תקן את הנוקאאוט →',
    'reopen.user.expires': 'פתוח עד {time}',
    'reopen.user.pendingTitle': '⚠️ ייתכן שצריך לבדוק את הנוקאאוט',
    'reopen.user.pendingSub': 'סליחה — תיקנו שגיאה בשיבוץ קבוצות מהמקום השלישי. בקש ממנהל הפול לפתוח לך בדיקת נוקאאוט.',
    ...
    'adminMembersEx.annexCReviewGlitch': 'סליחה — תיקנו שגיאה בשיבוץ הרשמי של FIFA לקבוצות מהמקום השלישי. {n} משתתפים בפול הזה קיבלו חלון של 7 ימים לבדוק/לתקן את הנוקאאוט ({annex} בגלל תיקון השיבוץ). הם מסומנים למטה.',
    'adminMembersEx.copyNudge': 'העתק הודעה לקבוצה',
    'adminMembersEx.nudgeMessage': 'היי לכולם! 👋 סליחה — FriendlyBet תיקן את שיבוצי הנוקאאוט הרשמיים של FIFA לקבוצות מהמקום השלישי. אנא היכנסו שוב ל-friendlybet.live ובדקו את שלב הנוקאאוט שלכם. בחירות הבתים ומלך השערים נעולות; רק הנוקאאוט פתוח לתיקון בזמן חלון התיקון. תודה 🙏',
  ...
  en: {
    ...
    'reopen.user.preKickoffTitle': '✅ Please review your knockout before lock',
    'reopen.user.preKickoffSub': 'Sorry — we corrected an error in the third-place pairings. You can review/edit the knockout now before the tournament starts. After lock, you will still have 7 days for knockout-only corrections.',
    'reopen.user.preKickoffCta': 'Review/edit now →',
    'reopen.user.preKickoffPendingTitle': '⚠️ Your knockout may need review',
    'reopen.user.preKickoffPendingSub': 'Sorry — we corrected an error in the third-place pairings. You can still review your knockout before lock.',
    'reopen.user.approvedTitle': '✅ Knockout review is open',
    'reopen.user.approvedSub': 'Sorry — we corrected an error in the third-place knockout pairings. Please review your bracket. Your group picks, third-place teams, and top scorer stay locked.',
    'reopen.user.cta': 'Review/edit knockout →',
    'reopen.user.expires': 'Open until {time}',
    'reopen.user.pendingTitle': '⚠️ Your knockout may need review',
    'reopen.user.pendingSub': 'Sorry — we corrected an error in the third-place pairings. Ask your pool admin to open knockout review for you.',
    ...
    'adminMembersEx.annexCReviewGlitch': 'Sorry — we corrected FIFA’s official third-place knockout pairing table. {n} member(s) in this pool now have 7 days to review/edit the knockout bracket ({annex} due to the pairing correction). They are flagged below.',
    'adminMembersEx.copyNudge': 'Copy a message to send',
    'adminMembersEx.nudgeMessage': 'Hey everyone! 👋 Sorry — FriendlyBet corrected FIFA’s official third-place knockout pairings. Please reopen friendlybet.live and review your knockout bracket. Your group picks and top scorer stay locked; only knockout can be edited during the correction window. Thanks 🙏',
