...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.liveStatus.lateKnockoutTitle': 'הבתים נעולים - הנוקאאוט ייפתח בקרוב',
    'dashboard.liveStatus.lateKnockoutText': 'אין כאן ניקוד על הבתים או מלך השערים. הזמינו חברים עכשיו; כולם ימלאו את הבראקט כשהבתים יסתיימו.',
    ...
    'dashboard.groupStageComplete.text': 'כל הבתים הושלמו והניקוד הרשמי של שלב הבתים נכנס. עכשיו הפוקוס עובר לנוקאאוט.',
    'pundit.title': 'הפרשן',
    ...
    'dashboard.twoPhase.knockoutOpenSub': 'בחר מנצחת בכל משחק. כל בחירה נשמרת מיד.',
  ...
  en: {
    ...
    'dashboard.liveStatus.lateKnockoutTitle': 'Groups are locked - knockouts open soon',
    'dashboard.liveStatus.lateKnockoutText': 'There are no group-stage or top-scorer points here. Invite friends now; everyone fills the bracket when the groups are complete.',
    ...
    'dashboard.groupStageComplete.text': 'All groups are finalized and official group-stage points are in. Now the focus moves to the knockout bracket.',
    ...
    'dashboard.twoPhase.knockoutOpenSub': 'Pick the winner of each match. Every pick saves immediately.',
