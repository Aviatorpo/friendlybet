...
const TRANSLATIONS = {
  he: {
    ...
    'reopen.championLocked': 'האלופה שלך ({team}) נעולה — חזור אחורה ושנה בחירות מוקדמות כך שהיא תגיע לגמר ותנצח.',
    'reopen.walkthroughNote': '🔒 האלופה שלך ({team}) נעולה. בנה את המסלול שמוביל אותה לגמר — הגמר חייב להסתיים בניצחון שלה.',
    'reopen.user.approvedTitle': '✅ אושר לך למלא מחדש את הנוקאאוט',
    'reopen.user.approvedSub': 'עקב תקלה הבראקט שלך לא נשמר. בחירות הבתים והאלופה נשארות נעולות — רק את הבראקט תמלא.',
    'reopen.user.cta': 'מלא את שלב הנוקאאוט →',
    'reopen.user.expires': 'פתוח עד {time}',
    'reopen.user.pendingTitle': '⚠️ שלב הנוקאאוט שלך לא נשמר',
    'reopen.user.pendingSub': 'עקב תקלה טכנית הבראקט שלך לא נשמר וההימור ננעל. בקש ממנהל הפול לאפשר לך מילוי מחדש.',
    'reopen.admin.allowBtn': 'אפשר מילוי מחדש של הנוקאאוט',
    ...
    'reopen.admin.personalMsg': 'היי {name}! 👋 שלב הנוקאאוט שלך ב-FriendlyBet לא נשמר עקב תקלה (בחירות הבתים שלך נשמרו ✓). אפשרתי לך למלא אותו מחדש — היכנס ל-friendlybet.live והשלם את הבראקט. תודה! 🙏',
    ...
    'adminMembersEx.nudgeMessage': 'היי לכולם! 👋 אנא היכנסו שוב ל-friendlybet.live ובדקו ששלב הנוקאאוט (הבראקט) שלכם נשמר במלואו. מצאנו תקלת שמירה שקטה שפגעה בחלק מהבראקטים, אז גם אם אתם בטוחים שסיימתם — אנא ודאו זאת, והשלימו אם משהו חסר, לפני שהמונדיאל מתחיל. תודה! 🙏',
  ...
  en: {
    ...
    'reopen.championLocked': 'Your champion ({team}) is locked — go back and change earlier picks so they reach the final and win it.',
    'reopen.walkthroughNote': '🔒 Your champion ({team}) is locked. Build the path that leads them to the final — the final must end with their win.',
    'reopen.user.approvedTitle': '✅ You’re approved to re-enter your knockout',
    'reopen.user.approvedSub': 'Your bracket wasn’t saved due to a glitch. Your group & champion picks stay locked — you only re-fill the bracket.',
    'reopen.user.cta': 'Fill your knockout stage →',
    'reopen.user.expires': 'Open until {time}',
    'reopen.user.pendingTitle': '⚠️ Your knockout bracket wasn’t saved',
    'reopen.user.pendingSub': 'Due to a technical glitch your bracket wasn’t saved and predictions are locked. Ask your pool admin to enable re-entry.',
    'reopen.admin.allowBtn': 'Allow knockout re-entry',
    ...
    'reopen.admin.personalMsg': 'Hi {name}! 👋 Your FriendlyBet knockout bracket wasn’t saved due to a glitch (your group picks are safe ✓). I’ve enabled re-entry for you — open friendlybet.live and finish your bracket. Thanks! 🙏',
    ...
    'adminMembersEx.nudgeMessage': 'Hey everyone! 👋 Please reopen friendlybet.live and double-check your full knockout bracket is saved. We found a silent save issue affecting some brackets, so even if you\'re sure you finished, please verify it — and complete it if anything\'s missing, before the World Cup starts. Thanks! 🙏',
