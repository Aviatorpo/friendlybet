...
const TRANSLATIONS = {
  he: {
    ...
    'wizard.step1.singlePhase.description': 'השחקנים מהמרים פעם אחת לפני תחילת המונדיאל. הם מנחשים הכל: מיקום בבתים, הברקאט המלא, מנצחת הטורניר, ומלך השערים. קל יותר - לא צריך לחזור!',
    'wizard.step1.twoPhase.title': 'הימור דו-שלבי',
    'wizard.step1.twoPhase.description': 'השחקנים מהמרים פעמיים: פעם לפני הבתים (רק מנצחי בתים), ופעם נוספת אחרי הבתים על הנוקאאוט ומלך השערים. יותר ריאלי, אבל דורש חזרה.',
    ...
    'recovery.button.continue': 'המשך לבריכה',
    'recovery.button.close': 'סגור',
    'recovery.warningModal.title': 'אתה בטוח?',
    'recovery.warningModal.text': 'עדיין לא שמרת את קוד השחזור. בלעדיו, לא תוכל להתחבר ממכשיר אחר.',
  ...
  en: {
    ...
    'wizard.step1.singlePhase.description': 'Players bet ONCE before the tournament starts. They predict everything: group positions, full bracket, tournament winner, and top scorer. Easier - no need to come back!',
    'wizard.step1.twoPhase.title': 'Two-Phase Betting',
    'wizard.step1.twoPhase.description': 'Players bet TWICE: once before groups (only group winners), then again after groups for knockout + top scorer. More realistic, but requires returning.',
    ...
    'recovery.warningModal.title': 'Are you sure?',
    'recovery.warningModal.text': 'You haven\'t saved your recovery code yet. Without it, you won\'t be able to log in from another device.',
