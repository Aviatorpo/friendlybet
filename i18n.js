...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.liveUpdating.text': 'התוצאה תתעדכן בסיום המשחק. הניקוד הרשמי נשאר על הדירוג האחרון עד שתהיה תוצאה סופית.',
    ...
    'matchesEx.liveScoreUpdatingNote': 'המשחק חי. התוצאה תתעדכן בסיום המשחק',
  ...
  en: {
    ...
    'dashboard.liveUpdating.text': 'The result will update after full-time. Official points stay on the last standings until there is a final result.',
    ...
    'matchesEx.liveScoreUpdatingNote': 'Match is live. The result will update after full-time.',
