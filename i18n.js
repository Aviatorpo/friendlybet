...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.liveStatus.lateKnockoutKicker': 'פול נוקאאוט',
    ...
    'dashboard.invite.lateKnockoutTitle': 'הזמינו חברים לפול נוקאאוט',
    ...
    'leaderboard.projection.source': 'מבוסס על {groups} מתוך {total} בתים עם תוצאה סופית או לייב אמין.',
    ...
    'poolFound.statusLateKnockoutOpen': 'פול נוקאאוט פתוח עד {time}',
  ...
  en: {
    ...
    'leaderboard.projection.source': 'Based on {groups} of {total} groups with a final result or trusted live score.',
