...
const TRANSLATIONS = {
  he: {
    ...
    'recovery.warningModal.text': 'צריך את קוד השחזור כדי להתחבר ממכשיר אחר. בלעדיו - אין דרך להיכנס לחשבון שלך מחדש.',
    ...
    'recovery.warningModal.yesSaved': 'כן, המשך לבריכה',
  ...
  en: {
    ...
    'recovery.warningModal.text': 'You need the recovery code to log in from another device. Without it, there\'s no way back into your account.',
