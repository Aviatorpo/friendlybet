...
const TRANSLATIONS = {
  he: {
    ...
    'tpRecovery.admin.grant': 'פתח תיקון נוקאאוט',
    'tpRecovery.admin.revoke': 'סגור גישה',
    'tpRecovery.admin.copy': 'העתק הודעה',
    'tpRecovery.admin.notOpened': 'אפשר לפתוח לו/לה תיקון אישי לנוקאאוט',
    ...
    'tpRecovery.admin.granted': 'גישת תיקון נפתחה',
    'tpRecovery.admin.revoked': 'גישת התיקון נסגרה',
    'tpRecovery.admin.notAvailable': 'לא ניתן לפתוח תיקון למשתתף הזה כרגע.',
    'tpRecovery.admin.personalMsg': 'היי {name}! FriendlyBet מתנצל: מילאת את הנוקאאוט בזמן שבו הבראקט שהוצג לא היה מדויק. פתחתי לך גישת תיקון אישית כדי לבדוק ולמלא מחדש את שלב הנוקאאוט. משחקים שכבר התחילו יישארו נעולים, ולכן כדאי להיכנס ל-friendlybet.live בהקדם.',
    'tpRecovery.user.title': 'תיקון אישי לנוקאאוט פתוח',
    'tpRecovery.user.sub': 'האדמין פתח לך גישה לבדוק ולתקן את שלב הנוקאאוט בגלל תקלה בבראקט. משחקים שכבר התחילו או תלויים בהם יישארו נעולים.',
    'tpRecovery.user.cta': 'תקן את הנוקאאוט',
    ...
    'tpRecovery.user.saved': 'תיקון הנוקאאוט נשמר.',
    'tpRecovery.user.notAvailable': 'גישת התיקון לא זמינה כרגע.',
    ...
    'matchesEx.statusBeingVerified': 'סטטוס המשחק נבדק עכשיו',
  ...
  en: {
    ...
    'tpRecovery.admin.grant': 'Open knockout recovery',
    'tpRecovery.admin.revoke': 'Close access',
    'tpRecovery.admin.copy': 'Copy message',
    'tpRecovery.admin.notOpened': 'You can open personal knockout recovery for this member',
    ...
    'tpRecovery.admin.granted': 'Recovery access opened',
    'tpRecovery.admin.revoked': 'Recovery access closed',
    'tpRecovery.admin.notAvailable': 'Recovery access is not available for this member right now.',
    'tpRecovery.admin.personalMsg': 'Hi {name}! FriendlyBet is sorry: you filled the knockout while the bracket shown to you was not accurate. I opened personal recovery access so you can review and refill the knockout stage. Matches that already started will stay locked, so please open friendlybet.live as soon as you can.',
    'tpRecovery.user.title': 'Personal knockout recovery is open',
    'tpRecovery.user.sub': 'Your admin opened access for you to review and correct the knockout stage because of the bracket issue. Matches that already started, and matches depending on them, stay locked.',
    'tpRecovery.user.cta': 'Correct knockout',
    ...
    'tpRecovery.user.saved': 'Knockout recovery saved.',
    'tpRecovery.user.notAvailable': 'Recovery access is not available right now.',
    ...
    'matchesEx.statusBeingVerified': 'Match status is being checked now',
    // v2.5.37: live minute labels (client-computed from match_date)
    'matchesEx.minute': "{n}'",
