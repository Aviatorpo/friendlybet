...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.adminNudge.sub': 'חלק מחברי הפול השלימו בתים ואלופה, אך הבראקט שלהם לא נשמר עקב תקלה. כדאי לתזכר אותם להשלים אותו לפני תחילת המונדיאל — אחרת יפסידו את רוב הנקודות.',
    ...
    'adminMembersEx.nudgeMessage': 'היי! 👋 בגלל תקלה טכנית קטנה, שלב הנוקאאוט (הבראקט) של חלק מכם לא נשמר — הבחירות של הבתים והאלופה כן נשמרו. אנא היכנסו שוב ל-friendlybet.live והשלימו את שלב הנוקאאוט לפני שהמונדיאל מתחיל. מצטערים על אי הנוחות! 🙏',
  ...
  en: {
    ...
    'dashboard.adminNudge.sub': 'Some members completed their groups & champion, but their bracket didn’t save due to a glitch. Remind them to finish it before the World Cup starts — otherwise they’ll miss out on most of the points.',
    ...
    'adminMembersEx.nudgeMessage': 'Hey! 👋 Due to a small technical glitch, the knockout stage (bracket) for some of you didn\'t save — your group and champion picks were saved. Please head back to friendlybet.live and complete your knockout bracket before the World Cup starts. Sorry for the inconvenience! 🙏',
