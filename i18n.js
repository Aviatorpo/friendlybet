...
const TRANSLATIONS = {
  he: {
    ...
    'recovery.warning.title': 'זה המפתח שלכם.',
    'recovery.warning.text': 'שמרו אותו ואל תשתפו — זו הדרך לחזור לחשבון.',
    'recovery.privacy': 'זה כמו סיסמה. שמור על פרטיות, אל תשתף.',
    'recovery.qr.scanHint': 'סרקו את ה-QR כדי להתחבר מיד, או הקלידו את הקוד ידנית.',
  ...
  en: {
    ...
    'recovery.warning.title': 'This is your key.',
    'recovery.warning.text': 'Save it, don\'t share it — it\'s how you get back in.',
    'recovery.privacy': 'It\'s like a password. Keep it private, don\'t share.',
    'recovery.qr.scanHint': 'Scan the QR to log in instantly, or type the code by hand.',
