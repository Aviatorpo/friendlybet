...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.liveStatus.lateKnockoutTitle': 'הנוקאאוט כבר התחיל',
    ...
    'dashboard.liveUpdating.badge': 'בודקים עכשיו',
    'dashboard.liveUpdating.title': 'מעדכנים את מצב המשחק',
    'dashboard.liveUpdating.text': 'יש משחק פעיל והמידע החי מתעדכן. הניקוד הרשמי נשאר על הדירוג האחרון עד שתהיה תוצאה סופית ומאומתת.',
    'dashboard.liveUpdating.note': 'אם התוצאה תשנה את הניקוד, הטבלה תתעדכן אוטומטית אחרי האימות.',
    ...
    'dashboard.groupStageComplete.title': 'הנוקאאוט כבר התחיל',
    'dashboard.groupStageComplete.text': 'ניקוד הבתים סופי, והמרדף עבר לנוקאאוט. הבראקטים נעולים עכשיו, וכל משחק יכול לשנות את הטבלה.',
    'dashboard.groupStageComplete.onePhaseText': 'ניקוד הבתים סופי, והנוקאאוט כבר רץ לפי הבראקט שמילאת מראש. כל משחק מכאן יכול להזיז את הטבלה.',
    'pundit.title': 'הפרשן',
    ...
    'dashboard.status.koReady': 'הנוקאאוט כבר רץ · 31 משחקים',
    'dashboard.status.partialKo': 'הימרת על {n} מתוך 31 · הנוקאאוט כבר רץ',
    ...
    'dashboard.twoPhase.knockoutOpenTitle': 'הנוקאאוט כבר התחיל',
    ...
    'leaderboard.statusGroupsComplete': 'הנוקאאוט כבר התחיל - הלידרבורד זז עם כל משחק',
    ...
    'matchesEx.liveUpdating': 'מעדכנים מצב משחק',
    'matchesEx.finished': 'הסתיים',
    'matchesEx.scoreAfterFinal': 'מאשרים את תוצאת הסיום',
    'matchesEx.liveResultAfterFinal': 'התוצאה החיה מתעדכנת. הניקוד הרשמי יחכה לתוצאת הסיום.',
    ...
    'matchesEx.liveScoreUpdatingNote': 'התוצאה החיה מתעדכנת. הניקוד הרשמי יחכה לתוצאת הסיום.',
  ...
  en: {
    ...
    'dashboard.liveStatus.lateKnockoutTitle': 'The knockouts are underway',
    ...
    'dashboard.liveUpdating.badge': 'Checking now',
    'dashboard.liveUpdating.title': 'Updating match state',
    'dashboard.liveUpdating.text': 'A match is active and live information is updating. Official points stay on the last verified standings until there is a confirmed final result.',
    'dashboard.liveUpdating.note': 'If the result changes the points, the table will update automatically after verification.',
    ...
    'dashboard.groupStageComplete.title': 'The knockouts are underway',
    'dashboard.groupStageComplete.text': 'Group points are final, and the chase has moved to the knockouts. Brackets are locked now, and every match can change the table.',
    'dashboard.groupStageComplete.onePhaseText': 'Group points are final, and the knockouts are already running through the bracket you submitted earlier. Every match from here can move the table.',
    ...
    'dashboard.status.koReady': 'Knockouts underway · 31 matches',
    'dashboard.status.partialKo': 'Picked {n} of 31 · knockouts underway',
    ...
    'dashboard.twoPhase.knockoutOpenTitle': 'The knockouts are underway',
    ...
    'leaderboard.statusGroupsComplete': 'Knockouts underway - the leaderboard moves with every match',
    ...
    'matchesEx.live': 'Live',
    'matchesEx.liveUpdating': 'Updating match state',
    'matchesEx.finished': 'Final',
    'matchesEx.scoreAfterFinal': 'Confirming final result',
    'matchesEx.liveResultAfterFinal': 'Live score is updating. Official points wait for the final result.',
    ...
    'matchesEx.liveScoreUpdatingNote': 'Live score is updating. Official points wait for the final result.',
