...
const TRANSLATIONS = {
  he: {
    ...
    'dashboard.projection.title': 'שום נקודה תיאורטית לא נספרת',
    'dashboard.projection.sub': 'זה רק מה היה קורה אם שלב הבתים היה נגמר עכשיו.',
    'dashboard.projection.subWithScore': '{points} נקודות תיאורטיות לפי {groups} בתים פעילים.',
    'dashboard.projection.rank': 'תיאורטי',
    'dashboard.projection.punditMe': 'הפרשן: כרגע זה מקום {rank}, אבל שער אחד יכול להפוך את כל הסיפור.',
    'dashboard.projection.punditLeader': 'הפרשן: כרגע {name} מוביל/ה תיאורטית עם {points}. זה עדיין לא נספר.',
    'dashboard.projection.punditZero': 'הפרשן: כרגע אין נקודות תיאורטיות, אבל הטבלה רק מתחילה לזוז.',
    ...
    'leaderboard.projection.title': 'אם הבתים היו נגמרים עכשיו',
    'leaderboard.projection.pill': 'לא רשמי',
    'leaderboard.projection.note': 'שום נקודה תיאורטית לא נספרת. זה רק חישוב זמני לפי טבלאות הבתים כרגע.',
    ...
    'leaderboard.projection.punditMe': 'הפרשן: כרגע היית במקום {rank} עם {points} נקודות תיאורטיות. אל תתרגל לזה יותר מדי.',
    'leaderboard.projection.punditLeader': 'הפרשן: כרגע {name} בראש עם {points} נקודות תיאורטיות. הטבלה הרשמית עדיין מחכה.',
    'leaderboard.projection.punditZero': 'הפרשן: עדיין אין נקודות תיאורטיות, אבל שער אחד יכול לפתוח את הדרמה.',
  ...
  en: {
    ...
    'dashboard.projection.title': 'No projection points are counted',
    'dashboard.projection.sub': 'This is only what would happen if the group stage ended right now.',
    'dashboard.projection.subWithScore': '{points} theoretical points from {groups} active groups.',
    'dashboard.projection.rank': 'Projected',
    'dashboard.projection.punditMe': 'The Pundit: right now that is rank {rank}, but one goal can flip the whole thing.',
    'dashboard.projection.punditLeader': 'The Pundit: {name} currently leads the projection with {points}. Still not counted.',
    'dashboard.projection.punditZero': 'The Pundit: no theoretical points yet, but the table is starting to move.',
    ...
    'leaderboard.projection.title': 'If the groups ended right now',
    'leaderboard.projection.pill': 'Not official',
    'leaderboard.projection.note': 'No projection points are counted. This is only a temporary calculation from the current group tables.',
    ...
    'leaderboard.projection.punditMe': 'The Pundit: right now you would be rank {rank} with {points} theoretical points. Do not get too comfortable.',
    'leaderboard.projection.punditLeader': 'The Pundit: {name} is top of the projection with {points}. The official table is still waiting.',
